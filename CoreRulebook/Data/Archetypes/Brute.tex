...
%%archBegin\archetype{Brute}{Beserker}{Gentle Giant}{0}{featureI=Incredible Strength, arcaneI=2, featureII=Natural Armour, arcaneII=2, alphaFeatureIII=Berserker Rage, betaFeatureIII=Protect Others, arcaneIII=2, featureIV=Unarmed Strike, betaFeatureIV=Gentle Aura, arcaneIV=2, featureV=Intimidating Presence, alphaFeatureV=Stunning Strike, arcaneV=3, featureVI=Giant Hands, betaFeatureVI=Nature Affinity, arcaneVI=3, alphaFeatureVII=Brutal Critical, arcaneVII=3, alphaFeatureVIII=Berserker Rage II, betaFeatureVIII=Protective Rampage, arcaneVIII=3, featureIX=Bludegoning Strength, arcaneIX=3, featureX=Natural Armour II, alphaFeatureX=Primal Senses, betaFeatureX=Carry Packs, arcaneX=4, betaFeatureXI=Brush Aside, arcaneXI=4, featureXII=Incredible Resilience, alphaFeatureXII=Impulsive Rush, arcaneXII=4, betaFeatureXIII=Gentle Aura II, arcaneXIII=4, arcaneXIV=4, featureXV=Raw Strength, alphaFeatureXV=Mindless Attacks, arcaneXV=5, betaFeatureXVI=Nature Affinity II, arcaneXVI=5, alphaFeatureXVII=Brutal Critical II, arcaneXVII=5, featureXVIII=Smite, betaFeatureXVIII=Pure Heart, arcaneXVIII=5, arcaneXIX=5, alphaFeatureXX=Berserker Rage III, betaFeatureXX=Pure Heart II, arcaneXX=6}%%archEnd
...
At 20th level, your purity imbues your fists with righteousness, and your unarmed strikes do an equal amount of Celestial damage.
