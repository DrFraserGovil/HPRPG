...
%%archBegin\archetype{Auror}{Enforcer}{Warder}{0}{featureI=Combat Training, arcaneI=2, featureII=Spellcasting Improvement, arcaneII=2, alphaFeatureIII=Intimidating Style, betaFeatureIII=Multiward, arcaneIII=2, featureIV=Defence Against the Dark Arts, arcaneIV=2, betaFeatureV=Runes, arcaneV=3, featureVI=Seasoned Investigator, alphaFeatureVI=Mage Slayer I, arcaneVI=3, featureVII=Spellcasting Improvement, alphaFeatureVII=Ethereal Manacles, arcaneVII=3, featureVIII=Combat Training II, betaFeatureVIII=Trap Expertise, arcaneVIII=3, alphaFeatureIX=Elegant Avoidance, betaFeatureIX=Wardbreaker, arcaneIX=3, featureX=Run \apos{}n Gun, arcaneX=4, alphaFeatureXI=Fast casting, betaFeatureXI=Runes II, arcaneXI=4, featureXII=Spellcasting Improvement, betaFeatureXII=Collateral Limitation, arcaneXII=4, alphaFeatureXIII=Intimidating Style II, arcaneXIII=4, arcaneXIV=4, featureXV=Incredible Resilience, alphaFeatureXV=Elegant Avoidance II, betaFeatureXV=Runes III, arcaneXV=5, arcaneXVI=5, featureXVII=Spellcasting Improvement, alphaFeatureXVII=Mage Slayer II, arcaneXVII=5, betaFeatureXVIII=Regenerative Shields, arcaneXVIII=5, arcaneXIX=5, alphaFeatureXX=Merciless Strike, betaFeatureXX=Runes IV, arcaneXX=6}%%archEnd
