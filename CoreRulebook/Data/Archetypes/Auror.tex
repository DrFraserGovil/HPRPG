...
%%archBegin\archetype{Auror}{Enforcer}{Warder}{0}{featureI=Combat Training, featureII=Spellcasting Improvement, betaFeatureII=Multiward, alphaFeatureIII=Shocking Arrival, featureIV=Defence Against the Dark Arts, alphaFeatureIV=Ambush, betaFeatureIV=Terrain Advantage, featureVI=Investigate Target, alphaFeatureVI=Close Quarters casting, featureVII=Spellcasting Improvement, alphaFeatureVII=Ethereal Manacles, alphaFeatureVIII=Elegant Avoidance, alphaFeatureIX=Fast casting, betaFeatureX=Runes, alphaFeatureXI=Mage Slayer, featureXII=Spellcasting Improvement, alphaFeatureXII=Magic Cleave, featureXIII=Combat Reflexes, featureXV=Incredible Resilience (see: hard to kill), alphaFeatureXV=Elegant Avoidance II, featureXVII=Spellcasting Improvement}%%archEnd
