...
%%archBegin\archetype{name=Warrior, hp=10, fp=6, armour=All Armour and Shields, tool=None, disc=Choose any three from Hexes\comma{} Curses\comma{} Elemental\comma{} Necromancy\comma{} Psionics\comma{} Warding \& Conjuration., weapon=All Weapons, prof=Choose any two from Strength\comma{} Speed\comma{} Vitality\comma{} Acrobatics\comma{} Willpower\comma{} Observation \& Intimidation, equip=A Wand\comma{} a Fighter\apos{}s pack including a weapon of your choice\comma{} and a set of Warrior Robes., memorised=Any three from the basic spells table., listIName =Stratagems Known, singleListMode = 1, expertI = 2, maxspellI = Beginner, bonusI = Fighting Paradigm\comma{} Paradigm Feature I, listI_I= -, expertII = 2, maxspellII = Beginner, bonusII = Through Gritted Teeth, listI_II= -, expertIII = 2, maxspellIII = Beginner, bonusIII = Combat Stratagem, listI_III= 3, expertIV = 3, maxspellIV = Novice, bonusIV = Paradigm Feature II, listI_IV= 3, expertV = 3, maxspellV = Novice, listI_V= 3, expertVI = 3, maxspellVI = Novice, bonusVI = Stratagem Improvement I, listI_VI= 4, expertVII = 3, maxspellVII = Novice, listI_VII= 4, expertVIII = 4, maxspellVIII = Adept, bonusVIII = Paradigm Feature III, listI_VIII= 4, expertIX = 4, maxspellIX = Adept, bonusIX = Stratagem Improvement II, listI_IX= 5, expertX = 4, maxspellX = Adept, listI_X= 5, expertXI = 4, maxspellXI = Expert, bonusXI = Firm Grip, listI_XI= 5, expertXII = 5, maxspellXII = Expert, listI_XII= 5, expertXIII = 5, maxspellXIII = Expert, bonusXIII = Paradigm Feature IV, listI_XIII= 5, expertXIV = 5, maxspellXIV = Master, bonusXIV = Stratagem Improvement III, listI_XIV= 6, expertXV = 5, maxspellXV = Master, listI_XV= 6, expertXVI = 6, maxspellXVI = Master, bonusXVI = Critical Striker, listI_XVI= 6, expertXVII = 6, maxspellXVII = Master, listI_XVII= 6, expertXVIII = 6, maxspellXVIII = Ascendant, bonusXVIII = Stratagem Improvement IV, listI_XVIII= 8, expertXIX = 6, maxspellXIX = Ascendant, listI_XIX= 8, expertXX = 7, maxspellXX = Ascendant, bonusXX = Paradigm Feature V, listI_XX= 8, shortmode = 0}
%%archEnd
