...
%%archBegin\archetype{Empath}{Seer}{Healer}{0}{featureI=Compassionate Heart, arcaneI=2, featureII=Perceptive Eyes, arcaneII=2, featureIII=Spellcasting Improvement, alphaFeatureIII=Channel Ability, betaFeatureIII=Healing hands\comma{} Tool Proficiency, arcaneIII=2, featureIV=Lie Detector, arcaneIV=2, alphaFeatureV=Arcane Focus, arcaneV=3, alphaFeatureVI=Psychic Trauma, betaFeatureVI=Effortless Healing, arcaneVI=3, featureVII=Compassionate Heart II, betaFeatureVII=Bane of Unlife, arcaneVII=3, featureVIII=Spellcasting Improvement, alphaFeatureVIII=Magical Nexus I, betaFeatureVIII=Red Cross, arcaneVIII=3, alphaFeatureIX=Other Eyes, arcaneIX=3, featureX=Empathic Shield, betaFeatureX=Mass heal, arcaneX=4, alphaFeatureXI=Retrocognition, arcaneXI=4, betaFeatureXII=Holistic Care, arcaneXII=4, featureXIII=Spellcasting Improvement, alphaFeatureXIII=Psychic Trauma II, arcaneXIII=4, alphaFeatureXIV=Font of Knowledge, betaFeatureXIV=Red Cross II, arcaneXIV=4, featureXV=Calming Aura, arcaneXV=5, arcaneXVI=5, betaFeatureXVII=Stabilizing Influence, arcaneXVII=5, featureXVIII=Spellcasting Improvement, alphaFeatureXVIII=Magical Nexus II, arcaneXVIII=5, arcaneXIX=5, alphaFeatureXX=True Sight, betaFeatureXX=Reverse Death, arcaneXX=6}%%archEnd
...
From 6th level, you may deduct half of your Healer level from the FP costs of healing spells (minimum 0). 
\jump
\feat{Bane of Unlife}
At 7th level, all healing spells cast are assumed to do an equal amount of Celestial damage. Celestial damage does not harm living beings, but banishes foul abominations. 
