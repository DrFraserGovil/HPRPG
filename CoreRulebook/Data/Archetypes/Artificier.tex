...
%%archBegin\archetype{Artificer}{Spellbinder}{Alchemist}{0}{featureI=Artisan{\apos}s Intuition, arcaneI=2, featureII=Appraising Eyes, arcaneII=2, featureIII=Tool Proficiency, alphaFeatureIII=Alteration Runes, betaFeatureIII=Attuned Nose\comma{} Natural Knowledge, arcaneIII=2, alphaFeatureIV=Renew Binding, arcaneIV=2, betaFeatureV=Careful Mixing, arcaneV=3, featureVI=Reliable Supplier, alphaFeatureVI=Disenchantment Ritual, arcaneVI=3, betaFeatureVII=Poison Resistance, arcaneVII=3, betaFeatureVIII=Proven Recipes, arcaneVIII=3, featureIX=Renowned Craftsmanship, alphaFeatureIX=Enchanting Specialty, arcaneIX=3, betaFeatureX=Favoured Effect, arcaneX=4, featureXI=Workshop, arcaneXI=4, alphaFeatureXII=Multiple Bindings, betaFeatureXII=Purity Filters, arcaneXII=4, alphaFeatureXIII=Soul Attunement, arcaneXIII=4, featureXIV=Artisan{\apos}s Intuition II, betaFeatureXIV=Favoured Effect II, arcaneXIV=4, alphaFeatureXV=Construct Mastery, betaFeatureXV=Poison Resistance II, arcaneXV=5, arcaneXVI=5, featureXVII=Appraising Eyes II, betaFeatureXVII=Purity Filters II, arcaneXVII=5, betaFeatureXVIII=Production Line, arcaneXVIII=5, arcaneXIX=5, alphaFeatureXX=Imbue Sentience, betaFeatureXX=Alchemic Construct, arcaneXX=6}%%archEnd
