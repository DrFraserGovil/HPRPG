...
\subfeat{Starry\minus{}Eyed}
{
	...
	This ability lasts for one hour, and cannot be re\minus{}activated until you take a Short Rest. 
...
\begin{center}
	...
	\begin{rndtable}{p{2.4cm} p {6.2cm} }
		...
		\entry{Protective Alder}{You gain a bonus to your block value equal to 1 + one\minus{}third your Druid level (rounded up).}
...
\subfeat{Encourage Growth}
{
	...
	\begin{itemize}[itemsep=0em]
		\boldItem{Nuture Plant}{Choose a single plant that you can see within range. Over the next minute, you can cause this plant to grow in size by a number of metres equal to one\minus{}third your druid level. You may guide this growth to an extent, causing it to sprout branches in a particular direction, or produce fruit. The plant growth must be within the realms of what the plant could achieve naturally \minus{} you merely accelerate and guide the process.}
...
\subfeat{Lay Down Roots}
{
	...
	\begin{itemize}[itemsep=0em]
		\boldItem{Groundhold}{Whilst your feet are on the ground, you cannot be moved unless you choose to be. Any magical or mundane effect which moves you through space (i.e. not teleportation effects) fails unless you choose to allow it.}
				...
				\item You cannot choose a creature which exceeds a given Ministry Rating, as determined by your Druid level:
					\begin{center}
						...
						\begin{rndtable}{p{1.2cm} c p{4.3cm} }
							...
							\beastEntry{14th}{V}{Erumpet, T\minus{}Rex}
						\end{rndtable}
					\end{center}
			\end{itemize}
