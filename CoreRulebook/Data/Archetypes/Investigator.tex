...
%%archBegin\archetype{Investigator}{Detective}{Journalist}{0}{featureI=Investigator's Insight, featureII=Interview, featureIII=Interrogator's Demeanor I, alphaFeatureIII=Arrest, betaFeatureIII=Connections, featureIV=Always Alert, betaFeatureIV=Eavesdrop I, alphaFeatureV=Police Tactics I, betaFeatureV=Silver Tongued, featureVI=Interrogator's Demeanor II, alphaFeatureVII=Gut Instinct, betaFeatureVII=Press Pass, alphaFeatureVIII=Good cop/Bad cop, betaFeatureVIII=Eavesdrop II, alphaFeatureIX=Evaluate Perp, betaFeatureIX=Hurtful Words, featureX=Research Team, featureXI=Interrogator's Demeanor III, alphaFeatureXI=Police Tactics II, betaFeatureXI=Contact Curation I, featureXII=Undercover, betaFeatureXII=Influence Opinion, alphaFeatureXIII=Evaluate Perp II, featureXIV=Interrogator's Demeanor IV, alphaFeatureXIV=Bent Copper / Honest Bobby, betaFeatureXV=Eavesdrop III, featureXVI=Illusive Deduction, betaFeatureXVIII=Contact Curation II, alphaFeatureXX=Sherlockian Deception, betaFeatureXX=Topple Regime}%%archEnd
...
At 15th level, you may choose one of the following paths:
\begin{itemize}
...
At 8th and 15th level, this increases to 10 and 20m radius respectively. In addition, at 15th level, you become aware of all hidden or invisible creatures in this radius. 



\jump\feat{Silver Tongued}

From 5th level, when performing an interview, you may choose one of the following checks:
\begin{itemize}
...
From 11th level, when checking to see if a connection has been `burned', you roll a d4 and the contact is only burned if the result is greater than 2 (decreasing burn chance from 75\% to 50\%).

From 18th level, the check must be equal to a 4 for the contact to be burned. 



\jump\feat{Influence Opinion}

?? Large scale psychic damage? Or maybe options? Think about it...
