...
%%archBegin\archetype{Investigator}{Detective}{Journalist}{0}{featureI=Investigator's Insight, featureII=Interview, featureIII=Interrogator's Demeanor I, alphaFeatureIII=Arrest, betaFeatureIII=Connections, featureIV=Always Alert, betaFeatureIV=Eavesdrop I\comma{} Hurtful Words, alphaFeatureV=Police Tactics I, featureVI=Interrogator's Demeanor II, betaFeatureVI=Influence Morale (d4), alphaFeatureVII=Gut Instinct, alphaFeatureVIII=Good cop/Bad cop, betaFeatureVIII=Silver Tongued, alphaFeatureIX=Evaluate Perp, betaFeatureIX=Influence Morale (d6), featureX=Research Team, betaFeatureX=Contact Curation I, featureXI=Interrogator's Demeanor III, alphaFeatureXI=Police Tactics II, featureXII=Undercover, alphaFeatureXII=Taser, betaFeatureXII=Influence Morale (d8), alphaFeatureXIII=Evaluate Perp II, featureXIV=Interrogator's Demeanor IV, alphaFeatureXV=Bent Copper / Honest Bobby, betaFeatureXV=Influence Morale (d10), featureXVI=Illusive Deduction, betaFeatureXVI=Manipulate Truth, alphaFeatureXVII=Restraining Force, betaFeatureXVIII=Influence Morale (d12), alphaFeatureXIX=Police Tactics III, betaFeatureXIX=Contact Curation II, alphaFeatureXX=Sherlockian Deception, betaFeatureXX=Topple Regime}%%archEnd
