...
HP regenerates slowly as minor wounds heal, at a rate of 2HP per hour whilst not in combat (unless there is a status effect blocking the healing effect), increasing to 5HP per hour when asleep. If you sleep for more than 8 hours, your HP is considered fully restored. However, status effects such as Serious Wound may impact the maximum HP which can be reached by natural healing, without external intervention. 

FP regenerates much faster, and can do so even whilst under fire. You gain 2FP per turn cycle in which you do not expend FP. Outside of combat, FP regenerates at a rate of 5FP per minute. However, status effects such as {\it Fatigue} can slow, or even entirely halt, FP regeneration. 
