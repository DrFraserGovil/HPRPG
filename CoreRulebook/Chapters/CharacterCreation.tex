...
If an effect which provides you with temporary health wears off whilst your HP exceeds your maximum health, you must reduce your HP to satisfy the current HP ceiling. 

Your maximum hit points are determined by your character archetype - each archetype gives a starting max HP, and then an amount by which to increase it each level. In addition, if you possess the {\it Vitality} proficiency, your health increases more rapidly.
...
As with health, you have three statistics associated with 
