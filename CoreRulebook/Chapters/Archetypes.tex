...
%%keyEnd    
      ...
      %%tableBegin
1  &  + \arcaneI & \parbox[t]{\w cm}{\featureI} & \parbox[t]{\w cm}{\alphaI}  &  \parbox[t]{\w cm}{\betaI}
 \\
2  &  + \arcaneII & \parbox[t]{\w cm}{\featureII} & \parbox[t]{\w cm}{\alphaII}  &  \parbox[t]{\w cm}{\betaII}
 \\
3  &  + \arcaneIII & \parbox[t]{\w cm}{\featureIII} & \parbox[t]{\w cm}{\alphaIII}  &  \parbox[t]{\w cm}{\betaIII}
 \\
4  &  + \arcaneIV & \parbox[t]{\w cm}{\featureIV} & \parbox[t]{\w cm}{\alphaIV}  &  \parbox[t]{\w cm}{\betaIV}
 \\
5  &  + \arcaneV & \parbox[t]{\w cm}{\featureV} & \parbox[t]{\w cm}{\alphaV}  &  \parbox[t]{\w cm}{\betaV}
 \\
6  &  + \arcaneVI & \parbox[t]{\w cm}{\featureVI} & \parbox[t]{\w cm}{\alphaVI}  &  \parbox[t]{\w cm}{\betaVI}
 \\
7  &  + \arcaneVII & \parbox[t]{\w cm}{\featureVII} & \parbox[t]{\w cm}{\alphaVII}  &  \parbox[t]{\w cm}{\betaVII}
 \\
8  &  + \arcaneVIII & \parbox[t]{\w cm}{\featureVIII} & \parbox[t]{\w cm}{\alphaVIII}  &  \parbox[t]{\w cm}{\betaVIII}
 \\
9  &  + \arcaneIX & \parbox[t]{\w cm}{\featureIX} & \parbox[t]{\w cm}{\alphaIX}  &  \parbox[t]{\w cm}{\betaIX}
 \\
10  &  + \arcaneX & \parbox[t]{\w cm}{\featureX} & \parbox[t]{\w cm}{\alphaX}  &  \parbox[t]{\w cm}{\betaX}
 \\
11  &  + \arcaneXI & \parbox[t]{\w cm}{\featureXI} & \parbox[t]{\w cm}{\alphaXI}  &  \parbox[t]{\w cm}{\betaXI}
 \\
12  &  + \arcaneXII & \parbox[t]{\w cm}{\featureXII} & \parbox[t]{\w cm}{\alphaXII}  &  \parbox[t]{\w cm}{\betaXII}
 \\
13  &  + \arcaneXIII & \parbox[t]{\w cm}{\featureXIII} & \parbox[t]{\w cm}{\alphaXIII}  &  \parbox[t]{\w cm}{\betaXIII}
 \\
14  &  + \arcaneXIV & \parbox[t]{\w cm}{\featureXIV} & \parbox[t]{\w cm}{\alphaXIV}  &  \parbox[t]{\w cm}{\betaXIV}
 \\
15  &  + \arcaneXV & \parbox[t]{\w cm}{\featureXV} & \parbox[t]{\w cm}{\alphaXV}  &  \parbox[t]{\w cm}{\betaXV}
 \\
16  &  + \arcaneXVI & \parbox[t]{\w cm}{\featureXVI} & \parbox[t]{\w cm}{\alphaXVI}  &  \parbox[t]{\w cm}{\betaXVI}
 \\
17  &  + \arcaneXVII & \parbox[t]{\w cm}{\featureXVII} & \parbox[t]{\w cm}{\alphaXVII}  &  \parbox[t]{\w cm}{\betaXVII}
 \\
18  &  + \arcaneXVIII & \parbox[t]{\w cm}{\featureXVIII} & \parbox[t]{\w cm}{\alphaXVIII}  &  \parbox[t]{\w cm}{\betaXVIII}
 \\
19  &  + \arcaneXIX & \parbox[t]{\w cm}{\featureXIX} & \parbox[t]{\w cm}{\alphaXIX}  &  \parbox[t]{\w cm}{\betaXIX}
 \\
20  &  + \arcaneXX & \parbox[t]{\w cm}{\featureXX} & \parbox[t]{\w cm}{\alphaXX}  &  \parbox[t]{\w cm}{\betaXX}
 \\
