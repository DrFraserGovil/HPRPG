\documentclass[CoreRulebook.tex]{subfile}
 ...
 %% Use the matlab script archetypeWriter to modify these. Don't do it by hand!
 \define@key{archetype}{arcaneI}{\def\arcaneI{#1}}
 \define@key{archetype}{firstLevelFeature}[None]{\def\firstLVLf{#1}}
 \define@key{archetype}{arcaneII}{\def\arcaneII{#1}}
  \define@key{archetype}{secondLevelFeature}[None]{\def\secondLVLf{#1}}
...
\\ 
1  &  + \arcaneI & \multicolumn{2}{c}{\firstLVLf} 
\\
2  &  + \arcaneII & \multicolumn{2}{c}{\secondLVLf} 
\\
3  &  + \arcaneIII & \parbox[t]{\w cm}{\raggedright\alphaIII}  &  \parbox[t]{\w cm}{\raggedright\betaIII}
 \\
4  &  + \arcaneIV & \parbox[t]{\w cm}{\raggedright\alphaIV}  &  \parbox[t]{\w cm}{\raggedright\betaIV}
 \\
5  &  + \arcaneV & \parbox[t]{\w cm}{\raggedright\alphaV}  &  \parbox[t]{\w cm}{\raggedright\betaV}
 \\
6  &  + \arcaneVI & \parbox[t]{\w cm}{\raggedright\alphaVI}  &  \parbox[t]{\w cm}{\raggedright\betaVI}
 \\
7  &  + \arcaneVII & \parbox[t]{\w cm}{\raggedright\alphaVII}  &  \parbox[t]{\w cm}{\raggedright\betaVII}
 \\
8  &  + \arcaneVIII & \parbox[t]{\w cm}{\raggedright\alphaVIII}  &  \parbox[t]{\w cm}{\raggedright\betaVIII}
 \\
9  &  + \arcaneIX & \parbox[t]{\w cm}{\raggedright\alphaIX}  &  \parbox[t]{\w cm}{\raggedright\betaIX}
 \\
10  &  + \arcaneX & \parbox[t]{\w cm}{\raggedright\alphaX}  &  \parbox[t]{\w cm}{\raggedright\betaX}
 \\
11  &  + \arcaneXI & \parbox[t]{\w cm}{\raggedright\alphaXI}  &  \parbox[t]{\w cm}{\raggedright\betaXI}
 \\
12  &  + \arcaneXII & \parbox[t]{\w cm}{\raggedright\alphaXII}  &  \parbox[t]{\w cm}{\raggedright\betaXII}
 \\
13  &  + \arcaneXIII & \parbox[t]{\w cm}{\raggedright\alphaXIII}  &  \parbox[t]{\w cm}{\raggedright\betaXIII}
 \\
14  &  + \arcaneXIV & \parbox[t]{\w cm}{\raggedright\alphaXIV}  &  \parbox[t]{\w cm}{\raggedright\betaXIV}
 \\
15  &  + \arcaneXV & \parbox[t]{\w cm}{\raggedright\alphaXV}  &  \parbox[t]{\w cm}{\raggedright\betaXV}
 \\
16  &  + \arcaneXVI & \parbox[t]{\w cm}{\raggedright\alphaXVI}  &  \parbox[t]{\w cm}{\raggedright\betaXVI}
 \\
17  &  + \arcaneXVII & \parbox[t]{\w cm}{\raggedright\alphaXVII}  &  \parbox[t]{\w cm}{\raggedright\betaXVII}
 \\
18  &  + \arcaneXVIII & \parbox[t]{\w cm}{\raggedright\alphaXVIII}  &  \parbox[t]{\w cm}{\raggedright\betaXVIII}
 \\
19  &  + \arcaneXIX & \parbox[t]{\w cm}{\raggedright\alphaXIX}  &  \parbox[t]{\w cm}{\raggedright\betaXIX}
 \\
20  &  + \arcaneXX & \parbox[t]{\w cm}{\raggedright\alphaXX}  &  \parbox[t]{\w cm}{\raggedright\betaXX}
 \\
		\end{tabular}
		\end{center}
...
\archetype{Gryffindor Student}{Sportsman}{Jester}{firstLevelFeature= Willpower and Endurance proficiencies +1,
									   secondLevelFeature = Heart of Bravery,
									   }
\twocolumn