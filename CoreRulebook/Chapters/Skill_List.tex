...
\skill{name =Runecaster,prerequisite=,  description =Once per day\comma{} you may utilise your knowledge of the ancient {\it Enchanting Runes} to form a magic spell from the endless chaos of primordial magic. 

As with the usual enchanting process\comma{} you must trace the runes out in the air over the course of a major action\comma{} describing what effect you would like this runechain to have. The GM then decides the spellschool and the difficulty of the described spell\comma{} based on the magnitude of the effect you are trying to create. You must then perform a casting check to realise the runecast. 

Runecasting is almost always weaker than a spell cast using the normal methods\comma{} though it provides much greater flexibility. You cannot runecast to exactly replicate the effects of an existing spell. 

After successfully performing a Runecast\comma{} you may spend 6 hours translating the runechain into a conventional incantation\minus{}based spell\comma{} with the discipline and DV set by the GM. You may then memory\minus{}cast this spell\comma{} and others may book\minus{}cast it\comma{} as they would any other spell., noPre = 1, n =1}
...
\skill{name =Surge,prerequisite=,  description =You may take one extra major action in your turn. This skill cannot be used again until you complete a long rest., noPre = 1, n =1}
