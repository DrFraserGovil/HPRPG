...
Create Water & \concSymb & Hovering Light & \instSymb & Cloudmove & \ritSymb & ~	 & ~	 & ~	 & ~	 & Tempest & \ritSymb
 \\ 
ET1 & \instSymb & Move Earth & \concSymb & Floodlight & \instSymb & ~	 & ~	 & ~	 & ~	 & ~	 & ~	
 \\ 
ET2 & \instSymb & Vortex Field & \instSymb & Freeze & \instSymb & ~	 & ~	 & ~	 & ~	 & ~	 & ~	
 \\ 
ET3 & \instSymb & ~	 & ~	 & Lightning Bolt & \instSymb & ~	 & ~	 & ~	 & ~	 & ~	 & ~	
 \\ 
ET4 & \instSymb & ~	 & ~	 & Wind Tunnel & \concSymb & ~	 & ~	 & ~	 & ~	 & ~	 & ~	
 \\ 
ET5 & \instSymb & ~	 & ~	 & ~	 & ~	 & ~	 & ~	 & ~	 & ~	 & ~	 & ~	
 \\ 
ET6 & \instSymb & ~	 & ~	 & ~	 & ~	 & ~	 & ~	 & ~	 & ~	 & ~	 & ~	
...
~	 & ~	 & Burst of Frost & \instSymb & Recurring Light & \concSymb & Electrical Arc & \concSymb & ~	 & ~	 & ~	 & ~	
 \\ 
~	 & ~	 & Crackling Fist & \instSymb & Stream of Acid & \concSymb & ~	 & ~	 & ~	 & ~	 & ~	 & ~	
 \\ 
~	 & ~	 & Shockwave & \instSymb & ~	 & ~	 & ~	 & ~	 & ~	 & ~	 & ~	 & ~	
\end{rndtable}
\vspace{3ex}
...
\\
 \multicolumn{2}{c}{\cellcolor{\tablecolorhead} \bf Beginner}&\multicolumn{2}{c}{\cellcolor{\tablecolorhead} \bf Novice}&\multicolumn{2}{c}{\cellcolor{\tablecolorhead} \bf Adept}&\multicolumn{2}{c}{\cellcolor{\tablecolorhead} \bf Expert}&\multicolumn{2}{c}{\cellcolor{\tablecolorhead} \bf Master}&\multicolumn{2}{c}{\cellcolor{\tablecolorhead} \bf Ascendant}
 \\ 
Instil Terror & \instSymb & Blight & \instSymb & Blood Barrier & \wardSymb & Blood Moon & \ritSymb & Create Horcrux & \ritSymb & Soul Snare & \instSymb
 \\ 
...
\spell{name = ET1, school = Charms, discipline = Elemental, type = Instant, level =Beginner, range =Self, noIncant = 1, noDur = 1, noHigh = 1, noResist =1, noBlock = 1, effect =a}
\spell{name = ET2, school = Charms, discipline = Elemental, type = Instant, level =Beginner, range =Self, noIncant = 1, noDur = 1, noHigh = 1, noResist =1, noBlock = 1, effect =a}
\spell{name = ET3, school = Charms, discipline = Elemental, type = Instant, level =Beginner, range =Self, noIncant = 1, noDur = 1, noHigh = 1, noResist =1, noBlock = 1, effect =a}
\spell{name = ET4, school = Charms, discipline = Elemental, type = Instant, level =Beginner, range =Self, noIncant = 1, noDur = 1, noHigh = 1, noResist =1, noBlock = 1, effect =a}
\spell{name = ET5, school = Charms, discipline = Elemental, type = Instant, level =Beginner, range =Self, noIncant = 1, noDur = 1, noHigh = 1, noResist =1, noBlock = 1, effect =a}
\spell{name = ET6, school = Charms, discipline = Elemental, type = Instant, level =Beginner, range =Self, noIncant = 1, noDur = 1, noHigh = 1, noResist =1, noBlock = 1, effect =a}
\spell{name = ET7, school = Charms, discipline = Elemental, type = Instant, level =Beginner, range =Self, noIncant = 1, noDur = 1, noHigh = 1, noResist =1, noBlock = 1, effect =a}
\spell{name = ET8, school = Charms, discipline = Elemental, type = Instant, level =Beginner, range =Self, noIncant = 1, noDur = 1, noHigh = 1, noResist =1, noBlock = 1, effect =a}
...
\spell{name = Knockout, school = Maledictions, discipline = Curse, type = Instant, level =Expert, range =Close, incant = stupefy, duration = 20 seconds,noHigh = 1, resist = Willpower, negation = Blockable  and Dodgeable,effect =If the spell hits the target\comma{} they are rendered {\it unconscious} for the duration of the spell. 
