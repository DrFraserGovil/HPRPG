...
Clean Surface & \concSymb & Cut Object & \instSymb & Cushion Fall & \instSymb & Apparate & \instSymb & Invert Gravity & \instSymb & Mass Kinesis & \concSymb
 \\ 
Halt & \instSymb & Lasso & \concSymb & Shatter & \concSymb & General Counterspell & \ritSymb & Shatterblast & \instSymb & Sphere of Immobility & \instSymb
 \\ 
Launder Clothes & \instSymb & Lock & \instSymb & Spider Hands & \instSymb & Leapfrog & \instSymb & Teleport & \instSymb & ~	 & ~	
 \\ 
Levitation & \concSymb & Repair Object & \concSymb & Summon Object & \concSymb & Stutterjump & \ritSymb & ~	 & ~	 & ~	 & ~	
 \\ 
Mage Hands & \instSymb & Upwards Blast & \instSymb & Unlock & \instSymb & Switch Places & \instSymb & ~	 & ~	 & ~	 & ~	
 \\ 
Mark Surface & \concSymb & Weld Objects & \instSymb & Walk on Water & \ritSymb & ~	 & ~	 & ~	 & ~	 & ~	 & ~	
\end{rndtable}
\vspace{3ex}
}
}
...
Knockback & \instSymb & Acidic Burst & \instSymb & Exploding Missile & \instSymb & Arctic Blast & \instSymb & Crush Bones & \instSymb & Disintegrate & \instSymb
 \\ 
Mortar Pulse & \instSymb & Bat Bogey Hex & \instSymb & Object Swarm & \concSymb & Black Dragon\apos{}s Fury & \concSymb & Meteor Strike & \instSymb & Heavenly Arsenal & \instSymb
 \\ 
Rainbow Sparks & \instSymb & Bolt from the Blue & \instSymb & Recurring Light & \concSymb & Detonation & \instSymb & ~	 & ~	 & ~	 & ~	
 \\ 
Sting & \instSymb & Crackling Fist & \instSymb & Spiral Inversion & \instSymb & ~	 & ~	 & ~	 & ~	 & ~	 & ~	
 \\ 
Ticklish Blast & \instSymb & Shockwave & \instSymb & Stream of Acid & \concSymb & ~	 & ~	 & ~	 & ~	 & ~	 & ~	
\end{rndtable}
\vspace{3ex}
}
}
...
\spell{name = Will\minus{}O\apos{}\minus{}the\minus{}Wisp, school = Dark Arts, discipline = Occultism, type = Instant, level =Novice, range =Close, incant = desuno, noDur = 1, higher = \additional{1d8}{fire and necrotic},resist = Willpower, negation = Blockable  and Dodgeable,effect =A small burst of rainbow light dances from the end of your wand\comma{} and streaks towards your opponent\comma{} dealing 1d8 fire damage and 1d8 necrotic damage when it makes contact.
