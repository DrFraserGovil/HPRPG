...
Contact Shock & \instSymb & Elemental Weapon & \instSymb & Animate Earth & \instSymb & Adjust Climate & \ritSymb & Fissure & \instSymb & Channel Cataclysm & \instSymb
 \\ 
Control Fire & \concSymb & Extinguish Flame & \instSymb & Charge Region & \wardSymb & Erupt & \instSymb & Tornado & \concSymb & Earthquake & \instSymb
 \\ 
Control Water & \concSymb & Hovering Light & \instSymb & Cloudmove & \ritSymb & ~	 & ~	 & ~	 & ~	 & Tempest & \ritSymb
 \\ 
Create Fire & \concSymb & Move Earth & \concSymb & Floodlight & \instSymb & ~	 & ~	 & ~	 & ~	 & ~	 & ~	
 \\ 
Create Water & \concSymb & Vortex Field & \instSymb & Freeze & \instSymb & ~	 & ~	 & ~	 & ~	 & ~	 & ~	
 \\ 
Fresh Air & \instSymb & ~	 & ~	 & Lightning Bolt & \instSymb & ~	 & ~	 & ~	 & ~	 & ~	 & ~	
 \\ 
Gust & \concSymb & ~	 & ~	 & Wind Tunnel & \concSymb & ~	 & ~	 & ~	 & ~	 & ~	 & ~	
 \\ 
...
\item Drown: if your animated water is within melee range of a being\comma{} you may wrap it around their face\comma{} depriving them of air on a failed Resist. Target can re\minus{}perform this check at the end of every turn. 
\end{spellitemize}}
