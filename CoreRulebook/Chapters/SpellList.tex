...
Contact Shock & \instSymb & Burst of Frost & \instSymb & Animate Earth & \instSymb & Adjust Climate & \ritSymb & Fissure & \instSymb & Channel Cataclysm & \instSymb
 \\ 
Control Fire & \concSymb & Dancing Bolt & \instSymb & Charge Region & \wardSymb & Drowning Sphere & \concSymb & Flame Whip & \instSymb & Earthquake & \instSymb
 \\ 
Control Water & \concSymb & Elemental Weapon & \instSymb & Cloudmove & \ritSymb & Electrical Arc & \concSymb & Tornado & \concSymb & Immolation & \instSymb
 \\ 
Create Fire & \concSymb & Extinguish Flame & \instSymb & Fireball & \instSymb & Erupt & \instSymb & Torrent & \instSymb & Tempest & \ritSymb
 \\ 
Create Water & \concSymb & Hovering Light & \instSymb & Floodlight & \instSymb & Flamethrower & \concSymb & ~	 & ~	 & Tsunami & \concSymb
 \\ 
Fresh Air & \instSymb & Ignite & \instSymb & Freeze & \instSymb & ~	 & ~	 & ~	 & ~	 & ~	 & ~	
 \\ 
Gust & \concSymb & Move Earth & \concSymb & Heat Object & \instSymb & ~	 & ~	 & ~	 & ~	 & ~	 & ~	
 \\ 
Illuminate Wand & \concSymb & Speedswim & \instSymb & Icicle & \instSymb & ~	 & ~	 & ~	 & ~	 & ~	 & ~	
 \\ 
Pebbledash & \instSymb & Vortex Field & \instSymb & Lightning Bolt & \instSymb & ~	 & ~	 & ~	 & ~	 & ~	 & ~	
 \\ 
...
Knockback & \instSymb & Acidic Burst & \instSymb & Exploding Missile & \instSymb & Arctic Blast & \instSymb & Crush Bones & \instSymb & Disintegrate & \instSymb
 \\ 
Magnetising Pulse & \instSymb & Bat Bogey Hex & \instSymb & Object Swarm & \concSymb & Black Dragon\apos{}s Fury & \concSymb & Meteor Strike & \instSymb & Heavenly Arsenal & \instSymb
 \\ 
...
\\
 \multicolumn{2}{c}{\cellcolor{\tablecolorhead} \bf Beginner}&\multicolumn{2}{c}{\cellcolor{\tablecolorhead} \bf Novice}&\multicolumn{2}{c}{\cellcolor{\tablecolorhead} \bf Adept}&\multicolumn{2}{c}{\cellcolor{\tablecolorhead} \bf Expert}&\multicolumn{2}{c}{\cellcolor{\tablecolorhead} \bf Master}&\multicolumn{2}{c}{\cellcolor{\tablecolorhead} \bf Ascendant}
 \\ 
Boost Health & \instSymb & Celestial Burst & \instSymb & Bless & \instSymb & Final Cure & \instSymb & Regenerate & \instSymb & Mass Healing & \instSymb
 \\ 
Minor Healing & \instSymb & Checkup & \instSymb & Countercurse & \instSymb & Major Healing & \instSymb & Suspended Animation & \ritSymb & Spark of Life & \ritSymb
 \\ 
Relinquish Grip & \instSymb & Clear Airways & \instSymb & Healing Lance & \instSymb & Shield of Mortality & \wardSymb & ~	 & ~	 & ~	 & ~	
 \\ 
Spare the Wounded & \instSymb & Endure Environment & \instSymb & Irongrip & \instSymb & ~	 & ~	 & ~	 & ~	 & ~	 & ~	
 \\ 
Stabilise Patient & \instSymb & Heal Wounds & \instSymb & Mend Bones & \instSymb & ~	 & ~	 & ~	 & ~	 & ~	 & ~	
 \\ 
~	 & ~	 & Stasis Field & \instSymb & Revive & \instSymb & ~	 & ~	 & ~	 & ~	 & ~	 & ~	
\end{rndtable}
\vspace{3ex}
}
\vbox{
...
Privacy Ward & \wardSymb & Reinforce Shield & \concSymb & Protective Field & \wardSymb & ~	 & ~	 & ~	 & ~	 & ~	 & ~	
 \\ 
Vengeance Field & \instSymb & Runic Shield & \wardSymb & Threshold Ward & \wardSymb & ~	 & ~	 & ~	 & ~	 & ~	 & ~	
\end{rndtable}
\vspace{3ex}
}
}
...
Change Colour & \instSymb & Fabricate Object & \instSymb & Alter Aura & \instSymb & Draconic Guardians & \instSymb & Fix Transformation & \ritSymb & Fearsome Guardians & \instSymb
 \\ 
Magical Makeover & \instSymb & Harden Object & \instSymb & Alter Size & \instSymb & Internal Extension & \instSymb & Selfshift & \instSymb & True Transfiguration & \instSymb
 \\ 
Slip & \concSymb & Horrific Armaments & \instSymb & Featherweight & \instSymb & Treacherous Terrain & \instSymb & ~	 & ~	 & ~	 & ~	
 \\ 
Small Change Charm & \instSymb & Stoneskin & \instSymb & Ironmass & \instSymb & ~	 & ~	 & ~	 & ~	 & ~	 & ~	
 \\ 
Transmutation & \instSymb & Thick Air & \concSymb & Sculpt Matter & \concSymb & ~	 & ~	 & ~	 & ~	 & ~	 & ~	
 \\ 
