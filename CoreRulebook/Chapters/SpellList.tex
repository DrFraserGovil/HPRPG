...
Clean Surface & \concSymb & Cut Object & \instSymb & Cushion Fall & \instSymb & Apparate & \instSymb & Invert Gravity & \instSymb & Mass Kinesis & \concSymb
 \\ 
Halt & \instSymb & Lock & \instSymb & Shatter & \concSymb & General Counterspell & \ritSymb & Shatterblast & \instSymb & Sphere of Immobility & \instSymb
 \\ 
Launder Clothes & \instSymb & Repair Object & \concSymb & Spider Hands & \instSymb & Leapfrog & \instSymb & Teleport & \instSymb & ~	 & ~	
 \\ 
Levitation & \concSymb & Weld Objects & \instSymb & Summon Object & \concSymb & Stutterjump & \ritSymb & ~	 & ~	 & ~	 & ~	
 \\ 
Mage Hands & \instSymb & ~	 & ~	 & Unlock & \instSymb & ~	 & ~	 & ~	 & ~	 & ~	 & ~	
 \\ 
Mark Surface & \concSymb & ~	 & ~	 & Walk on Water & \ritSymb & ~	 & ~	 & ~	 & ~	 & ~	 & ~	
\end{rndtable}
\vspace{3ex}
}
}
...
\spell{name = Bat Bogey Hex, school = Maledictions, discipline = Hex, type = Instant, level =Novice, range =Sight, incant = vespernasum, duration = 10 seconds,higher = Gain an additional bat \forEvery,noResist =1, negation = Blockable  and Dodgeable,effect =Causes the mucus in the target{\apos}s nose to gain sentience\comma{} take the form of a 2 tiny bats\comma{} and then attack the target. 
...
\spell{name = Calm Being, school = Illusion, discipline = Bewitchment, type = Instant, level =Novice, range =Sight, incant = paxus, noDur = 1, noHigh = 1, noResist =1, noBlock = 1, effect =Calms the target down. Remove {\it Terrified} status\comma{} {\it Rage} effects and  other related phenomena from target.}
...
\spell{name = Cause Confusion, school = Maledictions, discipline = Curse, type = Instant, level =Novice, range =Sight, incant = confundo, duration = 3 turns,noHigh = 1, resist = Willpower, noBlock = 1, effect =If target fails to resist\comma{} they take the {\it Confused} status.}
...
\spell{name = Fix Transformation, school = Transfiguration, discipline = Alteration, type = Ritual (30 seconds), level =Expert, range =Close, incant = perpetuus, noDur = 1, noHigh = 1, noResist =1, noBlock = 1, effect =When cast on any transfigured or conjured object\comma{} makes the transformation permanent and removes the time constraint. When a counterspell is used\comma{} this spell is removed and the countdown resumes.}
...
\spell{name = Harden Object, school = Transfiguration, discipline = Alteration, type = Instant, level =Novice, range =Sight, incant = duro, duration = 2 days,noHigh = 1, noResist =1, noBlock = 1, effect =Freezes a non\minus{}living object into its current form\comma{} such that it can no longer bend or flex. Hardened objects can absorb an additional 10 points of damage before they crumble and break.}
...
\spell{name = Mass Suggestion, school = Illusion, discipline = Bewitchment, type = Instant, level =Ascendant, range =Sight, incant = faciite maxima, duration = 12 hours,noHigh = 1, resist = Willpower, noBlock = 1, effect =Apply the {\it Suggestion} spell to 4d6 targets of your choice. The suggestion is the same to all targets.}
...
\spell{name = Mental Burden, school = Maledictions, discipline = Curse, type = Instant, level =Novice, range =Sight, incant = onus, duration = 1 turns,noHigh = 1, resist = Intelligence, noBlock = 1, effect =If the target fails to Resist\comma{} all spells cost 50\% more FP than their stated value for the duration of the spell.}
...
\spell{name = Petrify, school = Maledictions, discipline = Curse, type = Instant, level =Adept, range =Sight, incant = petrificus totalus, duration = 1 minute,noHigh = 1, resist = Power, negation = Blockable  and Dodgeable,effect =The target is {\it Paralyzed} as they are encased in a protective\comma{} petrifying layer of magic. 
...
\spell{name = Prevent Movement, school = Maledictions, discipline = Curse, type = Focus, level =Novice, range =Sight, incant = impedimentia, duration = 15 seconds,noHigh = 1, noResist =1, negation = Blockable  and Dodgeable,effect =As this spell hits the target\comma{} a magical rune forms on the floor beneath their feet\comma{} forcing their feet to remain rooted to the ground. The target acquires the Trapped status effect. Their remaining appendages are still free to move\comma{} and the target can still speak – but they cannot move until the spell ends.}
...
\spell{name = Sleep, school = Illusion, discipline = Bewitchment, type = Instant, level =Adept, range =Sight, incant = somnus, duration = 1 hour,noHigh = 1, resist = Willpower, noBlock = 1, effect =If a living target fails to resist the drowsiness that washes over them\comma{} they enter into a deep slumber.
...
\spell{name = Thick Air, school = Transfiguration, discipline = Alteration, type = Focus, level =Novice, range =Sight, incant = temporio, duration = 1 minute,higher = You may target an additional individual \forEvery{}.,resist = Speed, noBlock = 1, effect =Transforms the air around the 1d6 targets into a thick soup. Each targeted being must succeed on a Resist check or reduce their movement speed to 50\% of its normal value for the duration of the spell.}
...
\spell{name = Throw Voice, school = Illusion, discipline = Bewitchment, type = Focus, level =Beginner, range =Close, incant = ventrilofors, noDur = 1, noHigh = 1, noResist =1, noBlock = 1, effect =Cast your voice such that it appears to be coming from somewhere up to 5 metres away.}
...
\spell{name = Undo Transformation, school = Transfiguration, discipline = Alteration, type = Instant, level =Adept, range =Sight, incant = reparifarge, noDur = 1, noHigh = 1, noResist =1, noBlock = 1, effect =Transfiguration countercharm: undoes the effect of any one spell from the {\it Alteration} spell. 
