...
An entirely new artificing system was introduced!

The rune-based enchanting system and the ingredient-plus-flair alchemy system have been implemented, and I'm rather proud of them. 
...
\begin{itemize}
	...
	\item Spare Change Charm (Novice Alteration)
\end{itemize}
...
\begin{itemize}
	...
	\item The `immune', `resistant' and `susceptible' effects were elaborated on for the first time.
\end{itemize}
...
\begin{itemize}
	...
	\item  \st{Relook at armour section + see how to rework it better. }
