...
More realistic prices were added to the basic items and artifacts lists. 
...
\begin{itemize}
	\item Add an `attack' section that deals better with melee and ranged weapon attacks
	\item Relook at armour section + see how to rework it better. 
	\item Rework Stealth
	\item Statuses are garbage
	\item Get rid of living environment
