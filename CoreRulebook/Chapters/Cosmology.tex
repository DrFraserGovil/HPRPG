...
{\bf Planemeld Effect:} when melded with the mortal plane, Aeolus causes a stormcloud fills the region giving severe obscuration, and targets inside take 2d6 electric damage per turn.
...
{\bf Planemeld Effect:} when melded with the mortal plane, Hades forces ll beings below 50\% health to pass an ATH(health) check (DV 10) or die instantly.
