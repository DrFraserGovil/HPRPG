...
Following the basic \imp{artificing} guidelines given on page \pageref{S:ArtificingBasics}, you must first describe (as precisely as possible) the effect that you are trying to imbue into the target item, and describe why and how your selected runes allow you to perform this action. If the \imp{GM} concurs that your selected runes would create a \imp{nexus} for your chosen enchantment, they will choose a \imp{DV} and a required number of successes using the standard \imp{artificing} guidelines. 

For every 6 hours that you spend focussed entirely on the Imbuing process, you may perform an \imp{Imbuing} check. Every success you gain from the check is allocated into the project-pool. 
