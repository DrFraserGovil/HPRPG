...
\def\effectList{
	...
	\effect{Acidic}{Corrosive\comma{} inflicts acid damage and degrades physical objects.} {\imp{Basilisk Venom}, \imp{Dragon Blood} and \imp{Sphinx Saliva}}
	\effect{Aerosol}{Produces a cloud of gas or air\comma{} ideal for producing long\minus{}lasting clouds.} {\imp{Peppermint}, \imp{Dragon Fire Gland} and \imp{Nundu Venom Sac}}
	\effect{Amnesic}{Induces amnesia\comma{} causes a target to forget things} {\imp{Lethe Water}}
	\effect{Amplifying}{Increase the strength of the things it is applied to\comma{} either physically\comma{} magically or alchemically} {\imp{Mackled Malaclaw Tail}, \imp{Lobalug Venom} and \imp{Phlegiston Water}}
	\effect{Aphrodesiac}{Makes things appear beautiful\comma{} induces lust and desire} {\imp{Ashwinder Eggs}, \imp{Daisy} and \imp{Pearl Dust}}
	\effect{Aquatic}{Imbued with the essence of water\comma{} gives the consumer aspects of underwater creatures.} {\imp{Kelpie Hair}, \imp{Styx Water} and \imp{Gillyweed}}
	...
	\effect{Burning}{Creates heat and fire\comma{} can ward off cold\comma{} protect from fire or outright burn things} {\imp{Dragon Fire Gland}, \imp{Fire Crab Shell} and \imp{Pheonix Feather}}
	\effect{Colourful}{Brightly coloured\comma{} induces specific colour changes in the potion or its consumer} {\imp{Dragon Scale}, \imp{Fire Crab Shell} and \imp{Hippocampus Hair}}
	\effect{Conductive}{Allows electricty and heat to pass through easily} {\imp{Magnesium}, \imp{Moonstone} and \imp{Gold}}
	\effect{Confusing}{Induces confusion in the minds of living beings} {\imp{Vodka}, \imp{Lethe Water} and \imp{Doxy Eggs}}
	...
	\effect{Explosive}{Powerfully unstable\comma{} liable to explode or detonate} {\imp{Erumpet Horn}, \imp{Magnesium} and \imp{Boomberry}}
	\effect{Flexible}{Unbrittle and able to deform and contort\comma{} but always able to return to original shape} {\imp{Mallowsweet}, \imp{Murtlap Tentacles} and \imp{Fluxweed}}
	\effect{Floating}{Flies or moves about in space of its own accord} {\imp{Fairy Wings}, \imp{Aconite} and \imp{Thunderbird Feather}}
	\effect{Fortifying}{Increases the positive attributes of things – increases strength or intelligence (when applied correctly).} {\imp{Griffin Claw}, \imp{Troll Snot} and \imp{Re\apos{}em Blood}}
	\effect{Fragrant}{Has a pleasant aroma} {\imp{Boomberry}, \imp{Lavender} and \imp{Peppermint}}
	\effect{Freezing}{Cold to the touch: can ward off excess heat\comma{} protect from cold or freeze things solid} {\imp{Sphinx Saliva}, \imp{Dementor Cloak} and \imp{Frost Salamander Blood}}
	\effect{Hallucinogenic}{Induces euphoria and brings about visions and false memories.} {\imp{Billywig Sting}, \imp{Cocytus Water} and \imp{Kneazle Claw}}
	\effect{Hard}{Hard\comma{} unbending and immune to change – ideal for protective ointments} {\imp{Dragon Scale}, \imp{Dragon Claw} and \imp{Copper}}
	\effect{Healing}{Induces healing to living beings} {\imp{Nettles}, \imp{Dittany} and \imp{Murtlap Tentacles}}
	...
	\effect{Irritant}{Causes itching\comma{} swelling and boils to erupt on the skin} {\imp{Bubotuber Juice}, \imp{Bulbadox Powder} and \imp{Flobberworm Mucous}}
	...
	\effect{Melancholic}{Induces melancholy\comma{} despair and in extreme doses\comma{} terror} {\imp{Cocytus Water}, \imp{Dementor Cloak} and \imp{Pogrebin Shell}}
	\effect{Metamorphic}{Causes objects to alter their shape and change form} {\imp{Caterpillar}, \imp{Mercury} and \imp{Bicorn Horn}}
	\effect{Nutritious}{Supplies vitamins\comma{} minerals and energy for living beings and plants to thrive upon} {\imp{Honeywater}, \imp{Lemon Juice} and \imp{Mandrake Root}}
	\effect{Painful}{Creates incredible mind\minus{}numbing pain if consumed} {\imp{Acheron Water}}
	\effect{Paralytic}{Causes muscles to lock up and induce paralysis} {\imp{Acheron Water}, \imp{Bubotuber Juice} and \imp{Asp Tail}}
	\effect{Penetrating}{Seeps through defensive\comma{} or bursts through armour} {\imp{Bicorn Horn}, \imp{Sea\minus{}Serpent Spine} and \imp{Erumpet Horn}}
	\effect{Poisonous}{Toxic to living beings\comma{} inflicts poison damage} {\imp{Basilisk Venom}, \imp{Mercury} and \imp{Lobalug Venom}}
	\effect{Prescient}{Stimulates psychic abilities\comma{} allowing glimpses into the future\comma{} or into the minds of others} {\imp{Tea Leaf}, \imp{Kneazle Claw} and \imp{Cyclops Eye}}
	\effect{Preserving}{Prevents rot and decay\comma{} holds things as they are} {\imp{Acromantula Venom}}
	\effect{Purifying}{Drives away disease\comma{} poisons and corruption} {\imp{Pheonix Feather}, \imp{Bezoar} and \imp{Eye of Newt}}
	\effect{Radiant}{Emits a glow} {\imp{Pearl Dust}, \imp{Salamander Blood} and \imp{Pheonix Feather}}
	\effect{Resilient}{Unusually immune or resistive to external influence} {\imp{Dugbog Bark}, \imp{Wartcap Powder} and \imp{Manticore Skin}}
	\effect{Sapping}{Drains the positive attributes from things} {\imp{Leeches}, \imp{Glumbumble Treacle} and \imp{Grindylow Claw}}
	\effect{Slippery}{Causes things to slide\comma{} induces movement} {\imp{Mercury}, \imp{Morning Dew} and \imp{Murtlap Tentacles}}
	\effect{Smelly}{Has an unpleasant aroma} {\imp{Bundium Fluid}, \imp{Pungent Onion} and \imp{Flobberworm Mucous}}
	\effect{Soothing}{Calms the target of mental stress\comma{} prevents itchiness} {\imp{Squill Bulb}, \imp{Mooncalf Tears} and \imp{Murtlap Tentacles}}
	...
	\effect{Sticky}{Causes things to stick in place\comma{} prevents movement} {\imp{Troll Snot}, \imp{Stinksap} and \imp{Honeywater}}
	\effect{Stimulant}{Brings about mental acuity\comma{} prevents sleepiness} {\imp{Hippocampus Hair}, \imp{Ginger} and \imp{Dragon Claw}}
	\effect{Suffocating}{Prevents target from breathing} {\imp{Ash}, \imp{Grindylow Claw} and \imp{Nundu Venom Sac}}
	\effect{Tasty}{Yummy to eat} {\imp{Mallowsweet}, \imp{Lemon Juice} and \imp{Chizpurfle Fang}}
	...
	\effect{Voltaic}{Possessing or generating an electrical charge} {\imp{Raiju Shaving}, \imp{Copper} and \imp{Thunderbird Feather}}
}