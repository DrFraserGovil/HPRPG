...
\def\MythicalList{
	\ingredient{Angel’s Feather}{A feather of the purest white\comma{} glowing with incandescent magical power. Some say that they come from actual\comma{} real angels – whilst others are more doubtful about their origins.} {\imp{Gam}, \imp{Lucky}, \imp{Magical} and \imp{Purifying}}
...
\def\effectList{
	...
	\effect{Radiant}{Emits a glow} {\imp{Pearl Dust}, \imp{Dragon Blood} and \imp{Moonstone}}
	\effect{Resilient}{Unusually immune or resistive to external influence} {\imp{Vodka}, \imp{Knotgrass} and \imp{Wartcap Powder}}
	\effect{Sapping}{Drains the positive attributes from things} {\imp{Dragon Claw}, \imp{Glumbumble Treacle} and \imp{Leeches}}
	\effect{Slippery}{Causes things to slide\comma{} induces movement} {\imp{Mercury}, \imp{Morning Dew} and \imp{Murtlap Tentacles}}
	\effect{Smelly}{Has an unpleasant aroma} {\imp{Bundium Fluid}, \imp{Stinksap} and \imp{Flobberworm Mucous}}
	\effect{Soothing}{Calms the target of mental stress\comma{} prevents itchiness} {\imp{Asphodel}, \imp{Lavender} and \imp{Squill Bulb}}
	\effect{Soporific}{Sends things off to sleep} {\imp{Mooncalf Tears}, \imp{Lavender} and \imp{Sloth Brain}}
	\effect{Stabilising}{Prevents instability\comma{} makes things more predictable and reliable} {\imp{Lethe Water}, \imp{Eye of Newt} and \imp{Frost Salamander Blood}}
	\effect{Sticky}{Causes things to stick in place\comma{} prevents movement} {\imp{Glumbumble Treacle}, \imp{Bundium Fluid} and \imp{Stinksap}}
	\effect{Stimulant}{Brings about mental acuity\comma{} prevents sleepiness} {\imp{Ginger}, \imp{Bicorn Horn} and \imp{Tea Leaf}}
	\effect{Suffocating}{Prevents target from breathing} {\imp{Ash}, \imp{Grindylow Claw} and \imp{Nundu Venom Sac}}
	\effect{Tasty}{Yummy to eat} {\imp{Ginger}, \imp{Peppermint} and \imp{Squill Bulb}}
	...
	\effect{Voltaic}{Possessing or generating an electrical charge} {\imp{Raiju Shaving}, \imp{Copper} and \imp{Cyclops Eye}}
}