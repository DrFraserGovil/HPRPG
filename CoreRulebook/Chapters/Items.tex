...
Of course \minus{}\minus{} it is not just sapients that have `armour'\comma{} large creatures such as dragons have exceedingly strong scales that act as armour. The exact same rules apply to animal AC as to human AC\comma{} with the exception that each 1m$^2$ section of the beaing is considered an individual `piece' of armour. Breaking the armour on the tail\comma{} and then attacking the chest will obviously not work!

\subsection*{Restoring Armour}

Armour may be restored to working order by spending 3 hours reparing it (with a repair kit)\comma{} or by using a suitable magic spell.
