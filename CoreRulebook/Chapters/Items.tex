...
{
\\
	\parbox[t]{\y cm}{\raggedright\textbf{\textit{#1}}} & \parbox[t]{\w cm}{#2} &  \parbox[t]{\x cm}{\raggedright #3}	&	\parbox[t]{\u cm}{\centering #4}
...
\armour{Warded Cloth}{A recent magical invention\comma{} this expensive material hardens on impact\comma{} providing extra protection\comma{} whilst not impeding your movement.}{+2 Block}{15\galleon}
\end{rndtable}
\end{center}
\normalsize
...
\begin{rndtable}{p{\y cm} p{\w cm} p{\x cm} p{\u cm}}
\bf Type   &	\bf Description	&	\bf Effect	& \bf Cost
\armour{Bomb Suit}{Specially designed suit that one must climb inside. Used by professionals who frequently find themselves at risk of incineration or detonation}{+4 Block\comma{}\\ \minus{}6 Dodge \\ Resistance to Fire \& Concussive damage\comma{} \\Conspicuous.}{80\galleon}
\armour{Runic Plate}{Enchanted plates of metal fit together to provide full protection over your body\comma{} reminiscent of medieval plate armour.}{+7 Block\comma{}\\ \minus{}5 Dodge\comma{} \\ Conspicuous\comma{} \\ Resistance to Piercing \& Slashing damage.}{200\galleon}
