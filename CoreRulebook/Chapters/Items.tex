...
\armour{Formal Wear}{Extra suave look for the discerning witch or wizard. Ball gowns and tuxedoes are impractical\comma{} but you look amazing!}{\minus{}2 to Dodge\comma{} +2 to Charisma}{10\galleon}
\end{rndtable}
\end{center}
\normalsize
...
\begin{rndtable}{p{\x cm} p{\w cm} p{\x cm} c}
\bf Type   &	\bf Description	&	\bf Effect	& \bf Cost
\armour{Padded}{Formed from multiple layes of soft fabric and padding}{+2 to Block\comma{} \minus{}1 to Dodge}{2\galleon}
\armour{Warded Cloth}{A recent magical invention\comma{} this material hardens on impact\comma{} providing extra protection}{+1 to Block}{5\galleon}
\end{rndtable}
\end{center}
\normalsize
