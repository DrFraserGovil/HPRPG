...
\index{Nourishment|see{Fortitude (Regeneration)}}
%% CHAPTER BEGIN
\breaklesschapter{Personalities}\label{C:Personality}\index{Personalities}
...
\section{Gryffindor House}\index{Gryffindor}
...
\section{Hufflepuff House}\index{Hufflepuff}
...
\newpage
\section{Ravenclaw House}\index{Ravenclaw}
...
\section{Slytherin House}\index{Slytherin}
