...
This ability to bend the strands of fate is determined by the dual statistic of \key{ Heroism \& Villainy}. These two statistics are kept track on a single 7-dot line, with \imp{Heroism} being filled in from the left, and \imp{Villainy} being filled in from the right. 
