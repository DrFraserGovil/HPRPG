...
%%SpellBegin\scriptsize\schoolTables{Charms}
{
	\discTable{Elemental}
	{
 		\spellRow{  \spellEntry{Contact Shock}{\instSymb } }{  \spellEntry{Compel Flames}{\concSymb } }{  \spellEntry{Burst of Frost}{\instSymb } }{  \spellEntry{Broiling Beam}{\instSymb } }{  \spellEntry{Adjust Climate}{\ritSymb } }{  \spellEntry{Almighty Deluge}{\instSymb } }{  \spellEntry{Channel Cataclysm}{\instSymb } }

 		\spellRow{  \spellEntry{Glowing Wand}{\concSymb } }{  \spellEntry{Direct Fluids}{\concSymb } }{  \spellEntry{Dancing Bolt}{\instSymb } }{  \spellEntry{Cloudmove}{\ritSymb } }{  \spellEntry{Electrical Arc}{\concSymb } }{  \spellEntry{Fiery Whip}{\instSymb } }{  \spellEntry{Earthquake}{\instSymb } }

 		\spellRow{  \spellEntry{Pebbledash}{\instSymb } }{  \spellEntry{Earthrumble}{\instSymb } }{  \spellEntry{Douse Flame}{\instSymb } }{  \spellEntry{Fireball}{\instSymb } }{  \spellEntry{Erupting Earth}{\instSymb } }{  \spellEntry{Sorcerous Tornado}{\concSymb } }{  \spellEntry{Immolation}{\instSymb } }

 		\spellRow{  \spellEntry{Refreshing Breeze}{\instSymb } }{  \spellEntry{Hovering Globe}{\instSymb } }{  \spellEntry{Earthen Excavation}{\concSymb } }{  \spellEntry{Floodlight}{\instSymb } }{  \spellEntry{Icicle Barrage}{\instSymb } }{  \spellEntry{Yawning Fissue}{\instSymb } }{  \spellEntry{Primal Tempest}{\ritSymb } }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Howling Winds}{\concSymb } }{  \spellEntry{Far\minus{}Flung Flames}{\instSymb } }{  \spellEntry{Freeze Fluids}{\instSymb } }{  \spellEntry{Incinerating Expanse}{\concSymb } }{ \emptySpell{} }{  \spellEntry{Tsunami}{\concSymb } }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Produce Fire}{\concSymb } }{  \spellEntry{Speedswim}{\instSymb } }{  \spellEntry{Lightning Bolt}{\instSymb } }{  \spellEntry{Prime Spheroid}{\concSymb } }{ \emptySpell{} }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Produce Water}{\concSymb } }{  \spellEntry{Voltaic Surprise}{\wardSymb } }{  \spellEntry{Subsoil Construct}{\instSymb } }{  \spellEntry{Stonemeld}{\wardSymb } }{ \emptySpell{} }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{ \emptySpell{} }{  \spellEntry{Vortex Field}{\instSymb } }{  \spellEntry{Wind Tunnel}{\concSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }
	}
 ~ 

	\discTable{Kinesis}
	{
 		\spellRow{  \spellEntry{Housemage\apos{}s Delight}{\instSymb } }{  \spellEntry{Discarnate Digits}{\instSymb } }{  \spellEntry{Counterspell}{\instSymb } }{  \spellEntry{Dampen Deadly Drop}{\instSymb } }{  \spellEntry{Apparate/Disapparate}{\instSymb } }{  \spellEntry{Gravimetric Destabilisation}{\instSymb } }{  \spellEntry{Mass Kinesis}{\concSymb } }

 		\spellRow{  \spellEntry{Magical Marker}{\concSymb } }{  \spellEntry{Fusion}{\instSymb } }{  \spellEntry{Deadlock Seal}{\instSymb } }{  \spellEntry{Merlin\apos{}s Stutter}{\ritSymb } }{  \spellEntry{Leapfrog}{\instSymb } }{  \spellEntry{Sonic Sphere}{\instSymb } }{  \spellEntry{Sphere of Immobility}{\instSymb } }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Halt}{\instSymb } }{  \spellEntry{Destroy Lock}{\instSymb } }{  \spellEntry{Sonic Splinter}{\concSymb } }{ \emptySpell{} }{  \spellEntry{Teleportation Field}{\instSymb } }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Levitation}{\concSymb } }{  \spellEntry{Golden Lasso}{\concSymb } }{  \spellEntry{Spatial Swap}{\instSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Spectral Knife}{\instSymb } }{  \spellEntry{Reconstruction}{\concSymb } }{  \spellEntry{Spidercrawl}{\instSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{ \emptySpell{} }{  \spellEntry{Vertical Burst}{\instSymb } }{  \spellEntry{Summon From Afar}{\concSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{ \emptySpell{} }{  \spellEntry{Walk on Water}{\ritSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }
	}
 ~ 

}

\schoolTables{Divination}
{
	\discTable{Telepathy}
	{
 		\spellRow{  \spellEntry{Eavesdrop}{\concSymb } }{  \spellEntry{Aid Ally}{\instSymb } }{  \spellEntry{Bestial Ally}{\instSymb } }{  \spellEntry{Commune with Nature}{\ritSymb } }{  \spellEntry{Disrupt Connection}{\instSymb } }{  \spellEntry{Link Inversion}{\instSymb } }{  \spellEntry{Join Minds}{\ritSymb } }

 		\spellRow{  \spellEntry{Insight}{\instSymb } }{  \spellEntry{Comprehend Languages}{\ritSymb } }{  \spellEntry{Detect Minds}{\concSymb } }{  \spellEntry{Ethereal Tag}{\instSymb } }{  \spellEntry{Occlumency}{\ritSymb } }{  \spellEntry{Network of the Minds}{\ritSymb } }{  \spellEntry{True Sight}{\ritSymb } }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Detect Magic}{\instSymb } }{  \spellEntry{Divine Truth}{\concSymb } }{  \spellEntry{Psychic Immersion}{\concSymb } }{  \spellEntry{Scry}{\ritSymb } }{ \emptySpell{} }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Engender Anxiety}{\instSymb } }{  \spellEntry{Telepathic Bond}{\ritSymb } }{  \spellEntry{Speak in Tongues}{\ritSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Eyes of the Beast}{\concSymb } }{  \spellEntry{Trapsense}{\concSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Night Vision}{\instSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }
	}
 ~ 

	\discTable{Temporal}
	{
 		\spellRow{  \spellEntry{Detect Casting Residue}{\instSymb } }{  \spellEntry{Attuned Reactions}{\instSymb } }{  \spellEntry{All\minus{}seeing Eye}{\instSymb } }{  \spellEntry{Astral Onslaught}{\instSymb } }{  \spellEntry{Legends of the Past}{\instSymb } }{  \spellEntry{Astral Cloak}{\instSymb } }{  \spellEntry{Astral Projection}{\ritSymb } }

 		\spellRow{  \spellEntry{Pocketwatch}{\instSymb } }{  \spellEntry{Crystal Gazing}{\ritSymb } }{  \spellEntry{Astral Caltrops}{\instSymb } }{  \spellEntry{Foresight}{\instSymb } }{  \spellEntry{Mists of Time}{\ritSymb } }{  \spellEntry{Contingency}{\instSymb } }{  \spellEntry{Control Time}{\ritSymb } }

 		\spellRow{  \spellEntry{Receive Omen}{\ritSymb } }{  \spellEntry{Distressing Omen}{\instSymb } }{  \spellEntry{Glimpse Future}{\instSymb } }{  \spellEntry{Locate Being}{\instSymb } }{  \spellEntry{Temporal Shear}{\instSymb } }{ \emptySpell{} }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Identify Object}{\ritSymb } }{  \spellEntry{Hunter\apos{}s Mark}{\instSymb } }{  \spellEntry{Obfuscation}{\ritSymb } }{  \spellEntry{Timeslip}{\instSymb } }{ \emptySpell{} }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Locate Object}{\instSymb } }{  \spellEntry{Otherworldly Sight}{\instSymb } }{  \spellEntry{Tumble Through Time}{\concSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Seeker\apos{}s Sight}{\instSymb } }{  \spellEntry{Timespike}{\concSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }
	}
 ~ 

}

\schoolTables{Illusion}
{
	\discTable{Bewitchment}
	{
 		\spellRow{  \spellEntry{Lure}{\instSymb } }{  \spellEntry{Aura of Kindness}{\instSymb } }{  \spellEntry{Calm Being}{\instSymb } }{  \spellEntry{Bedazzle}{\wardSymb } }{  \spellEntry{Beguiling Totem}{\instSymb } }{  \spellEntry{Invisibility}{\wardSymb } }{  \spellEntry{True Illusion}{\ritSymb } }

 		\spellRow{  \spellEntry{Minor Trickery}{\instSymb } }{  \spellEntry{Blur}{\instSymb } }{  \spellEntry{Charm Creature}{\instSymb } }{  \spellEntry{Captivate}{\instSymb } }{  \spellEntry{Hidden Hologram}{\wardSymb } }{  \spellEntry{Mass Suggestion}{\instSymb } }{ \emptySpell{} }

 		\spellRow{  \spellEntry{Throw Voice}{\concSymb } }{  \spellEntry{Glamour}{\instSymb } }{  \spellEntry{Conceal Inscription}{\instSymb } }{  \spellEntry{Illusory Construct}{\concSymb } }{  \spellEntry{Perfect Disguise}{\instSymb } }{  \spellEntry{Soul Ripple}{\instSymb } }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Hypnotic Lights}{\instSymb } }{  \spellEntry{Doppelg\umlaut{a}ngers}{\instSymb } }{  \spellEntry{Mindpurge}{\instSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Illusory Form}{\concSymb } }{  \spellEntry{Implant Message}{\wardSymb } }{  \spellEntry{Sleep}{\instSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }{  \spellEntry{Suggestion}{\instSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }
	}
 ~ 

	\discTable{Psionics}
	{
 		\spellRow{  \spellEntry{Manipulate Emotions}{\instSymb } }{  \spellEntry{Commanding Word}{\instSymb } }{  \spellEntry{Babbling}{\instSymb } }{  \spellEntry{Delusion}{\instSymb } }{  \spellEntry{Psychosis}{\instSymb } }{  \spellEntry{Linguistic Aphasia}{\instSymb } }{  \spellEntry{Destroy Mind}{\instSymb } }

 		\spellRow{  \spellEntry{Pummeling Thoughts}{\instSymb } }{  \spellEntry{False Friendship}{\instSymb } }{  \spellEntry{Illiteracy}{\instSymb } }{  \spellEntry{Fury}{\instSymb } }{  \spellEntry{Relive Memory}{\instSymb } }{  \spellEntry{Modify Memory}{\instSymb } }{  \spellEntry{Mass Delusion}{\instSymb } }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Incessant Whispers}{\concSymb } }{  \spellEntry{Psychic Crush}{\instSymb } }{  \spellEntry{Shatter Illusions}{\instSymb } }{  \spellEntry{Waking Dreams}{\concSymb } }{  \spellEntry{Psionic Overload}{\instSymb } }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Overpowering Humiliation}{\wardSymb } }{  \spellEntry{Violent Phantasms}{\instSymb } }{  \spellEntry{Silence}{\instSymb } }{ \emptySpell{} }{  \spellEntry{Psychosomatism}{\concSymb } }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Psychic Scream}{\instSymb } }{ \emptySpell{} }{  \spellEntry{Suppress Intelligence}{\instSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Shrivelled Ears}{\instSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }
	}
 ~ 

}

\schoolTables{Maledictions}
{
	\discTable{Curse}
	{
 		\spellRow{  \spellEntry{Backlash}{\instSymb } }{  \spellEntry{Bubbling Warts}{\instSymb } }{  \spellEntry{Conjunctivitis}{\instSymb } }{  \spellEntry{Break Focus}{\instSymb } }{  \spellEntry{Cursed Step}{\instSymb } }{  \spellEntry{Corrupt Object}{\ritSymb } }{  \spellEntry{Revoke Power}{\instSymb } }

 		\spellRow{  \spellEntry{Confound}{\instSymb } }{  \spellEntry{Curse of the Bogies}{\instSymb } }{  \spellEntry{Dilute Blood}{\instSymb } }{  \spellEntry{Comatosing Blast}{\instSymb } }{  \spellEntry{Major Curse}{\ritSymb } }{  \spellEntry{Crystalrot}{\instSymb } }{  \spellEntry{Taboo}{\ritSymb } }

 		\spellRow{  \spellEntry{Palpatation}{\instSymb } }{  \spellEntry{Jelly Legs}{\concSymb } }{  \spellEntry{Disarm}{\instSymb } }{  \spellEntry{Delayed Effect}{\instSymb } }{  \spellEntry{Shield Breaker}{\instSymb } }{  \spellEntry{Wither}{\instSymb } }{ \emptySpell{} }

 		\spellRow{  \spellEntry{Sudden Sound}{\instSymb } }{  \spellEntry{Jinx}{\instSymb } }{  \spellEntry{Disorient}{\instSymb } }{  \spellEntry{Petrify}{\instSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Stickfast}{\instSymb } }{  \spellEntry{Prevent Movement}{\concSymb } }{  \spellEntry{Strangle}{\instSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Taste of Blood}{\wardSymb } }{ \emptySpell{} }{  \spellEntry{Trojan Undermining}{\instSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }
 ...
 ~ 
	...
	\discTable{Hex}
	{
 		\spellRow{  \spellEntry{Knockback}{\instSymb } }{  \spellEntry{Magnetising Strike}{\instSymb } }{  \spellEntry{Acidic Burst}{\instSymb } }{  \spellEntry{Exploding Missile}{\instSymb } }{  \spellEntry{Arctic Blast}{\instSymb } }{  \spellEntry{Bonecrusher}{\instSymb } }{  \spellEntry{Disintegration}{\instSymb } }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Mortar Pulse}{\instSymb } }{  \spellEntry{Bat Bogey Hex}{\instSymb } }{  \spellEntry{Object Swarm}{\concSymb } }{  \spellEntry{Black Dragon\apos{}s Fury}{\concSymb } }{  \spellEntry{Meteor Strike}{\instSymb } }{  \spellEntry{Heavenly Arsenal}{\instSymb } }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Rainbow Sparks}{\instSymb } }{  \spellEntry{Bolt from the Blue}{\instSymb } }{  \spellEntry{Recurring Light}{\concSymb } }{  \spellEntry{Sundering}{\instSymb } }{ \emptySpell{} }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Sting}{\instSymb } }{  \spellEntry{Crackling Fist}{\instSymb } }{  \spellEntry{Spiral Inversion}{\instSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Ticklish Blast}{\instSymb } }{  \spellEntry{Shockwave}{\instSymb } }{  \spellEntry{Stream of Acid}{\concSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }{  \spellEntry{Witch Hunter\apos{}s Bane}{\instSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }
	}
 ~ 

}

\schoolTables{Recuperation}
{
	\discTable{Healing}
	{
 		\spellRow{  \spellEntry{Freebreathe}{\instSymb } }{  \spellEntry{Ceremony of Life}{\ritSymb } }{  \spellEntry{Endure Environment}{\instSymb } }{  \spellEntry{Countercurse}{\instSymb } }{  \spellEntry{Arcane Surgery}{\ritSymb } }{  \spellEntry{Healing Barrage}{\instSymb } }{  \spellEntry{Cure the Masses}{\instSymb } }

 		\spellRow{  \spellEntry{Purify}{\instSymb } }{  \spellEntry{Checkup}{\instSymb } }{  \spellEntry{Healing Lance}{\instSymb } }{  \spellEntry{Mass Remedy}{\instSymb } }{  \spellEntry{Final Cure}{\instSymb } }{  \spellEntry{Mungo\apos{}s Metamorphasis}{\concSymb } }{  \spellEntry{Spark of Life}{\ritSymb } }

 		\spellRow{  \spellEntry{Resistance}{\instSymb } }{  \spellEntry{Heightened Vitality}{\instSymb } }{  \spellEntry{Radiant Burst}{\instSymb } }{  \spellEntry{Revive}{\instSymb } }{  \spellEntry{Major Healing}{\instSymb } }{ \emptySpell{} }{ \emptySpell{} }

 		\spellRow{  \spellEntry{Stabilisation}{\instSymb } }{  \spellEntry{Mercy}{\wardSymb } }{  \spellEntry{Restore}{\instSymb } }{  \spellEntry{Suspended Animation}{\ritSymb } }{  \spellEntry{Shield of Mortality}{\wardSymb } }{ \emptySpell{} }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Relinquish Grip}{\instSymb } }{  \spellEntry{Stasis Field}{\instSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Remedy}{\instSymb } }{  \spellEntry{Witchdoctor\apos{}s Touch}{\instSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }
	}
 ~ 

	\discTable{Warding}
	{
 		\spellRow{  \spellEntry{Defensive Flare}{\wardSymb } }{  \spellEntry{Arcane Shield}{ } }{  \spellEntry{Beartrap}{\wardSymb } }{  \spellEntry{Anti\minus{}Muggle Ward}{\wardSymb } }{  \spellEntry{Abjure the Undead}{\wardSymb } }{  \spellEntry{Anti\minus{}Apparition Ward}{\wardSymb } }{  \spellEntry{Fidelius Ward}{\ritSymb } }

 		\spellRow{  \spellEntry{Hidden Ember}{\wardSymb } }{  \spellEntry{Caterwauling Alarm}{\wardSymb } }{  \spellEntry{Halting Field}{\wardSymb } }{  \spellEntry{Blade Wall}{\wardSymb } }{  \spellEntry{Ironwall}{\wardSymb } }{  \spellEntry{Anti\minus{}Magic Ward}{\wardSymb } }{  \spellEntry{Total Disruption Field}{\wardSymb } }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Flame Freezing}{\wardSymb } }{  \spellEntry{Reinforce Shield}{\concSymb } }{  \spellEntry{Distant Shield}{\instSymb } }{  \spellEntry{Morgana\apos{}s Greed}{\wardSymb } }{ \emptySpell{} }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Imbibing Rune}{\wardSymb } }{  \spellEntry{Runic Shield}{\wardSymb } }{  \spellEntry{Minefield}{\wardSymb } }{  \spellEntry{Patronus}{\instSymb } }{ \emptySpell{} }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Privacy Ward}{\wardSymb } }{  \spellEntry{Threshold Ward}{\wardSymb } }{  \spellEntry{Protective Field}{\wardSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Silent Step}{\wardSymb } }{ \emptySpell{} }{  \spellEntry{Zone of Silence}{\wardSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Vengeance Field}{\instSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }
	}
 ~ 

}

\schoolTables{Transfiguration}
{
	\discTable{Alteration}
	{
 		\spellRow{  \spellEntry{Aerodynamic Rectification}{\instSymb } }{  \spellEntry{Degrade}{\instSymb } }{  \spellEntry{Alter Size}{\instSymb } }{  \spellEntry{Alter Astral Aspect}{\instSymb } }{  \spellEntry{Draconic Guardians}{\instSymb } }{  \spellEntry{Mass Reshape Body}{\instSymb } }{  \spellEntry{Guardian Army}{\instSymb } }

 		\spellRow{  \spellEntry{Magical Makeover}{\instSymb } }{  \spellEntry{Horrific Armaments}{\instSymb } }{  \spellEntry{Fabricate Object}{\instSymb } }{  \spellEntry{Irongrip}{\instSymb } }{  \spellEntry{Elemental Imbuement}{\ritSymb } }{  \spellEntry{Permanence}{\ritSymb } }{  \spellEntry{True Transfiguration}{\instSymb } }

 		\spellRow{  \spellEntry{Small Change Charm}{\instSymb } }{  \spellEntry{Refine}{\instSymb } }{  \spellEntry{Featherweight}{\instSymb } }{  \spellEntry{Ironmass}{\instSymb } }{  \spellEntry{Treacherous Terrain}{\instSymb } }{  \spellEntry{Selfshift}{\instSymb } }{ \emptySpell{} }

 		\spellRow{  \spellEntry{Touch of Colour}{\instSymb } }{  \spellEntry{Slip}{\concSymb } }{  \spellEntry{Stoneskin}{\instSymb } }{  \spellEntry{Reshape Body}{\instSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Solidify \& Strengthen}{\instSymb } }{  \spellEntry{Thick Air}{\concSymb } }{  \spellEntry{Sculpt Matter}{\concSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Transmutation}{\instSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }
	}
 ~ 

	\discTable{Conjuration}
	{
 		\spellRow{  \spellEntry{Conjure Flowers}{\instSymb } }{  \spellEntry{Conjure Bubble}{\instSymb } }{  \spellEntry{Bestial Summons}{\instSymb } }{  \spellEntry{Banish}{\instSymb } }{  \spellEntry{Conjure Elemental}{\instSymb } }{  \spellEntry{Dimensional Binding}{\ritSymb } }{  \spellEntry{Archon\apos{}s Spirit}{\ritSymb } }

 		\spellRow{  \spellEntry{Prank}{\instSymb } }{  \spellEntry{Erupting Spike}{\instSymb } }{  \spellEntry{Binding Ropes}{\instSymb } }{  \spellEntry{Duplicate Object}{\instSymb } }{  \spellEntry{Create Golem}{\ritSymb } }{  \spellEntry{Extraplanar Champion}{\ritSymb } }{  \spellEntry{Riftstorm}{\concSymb } }

 		\spellRow{  \spellEntry{Swordstrike}{\instSymb } }{  \spellEntry{Grasping Tendrils}{\instSymb } }{  \spellEntry{Conjure Object}{\ritSymb } }{  \spellEntry{Entombment}{\instSymb } }{  \spellEntry{Summon Monster}{\instSymb } }{ \emptySpell{} }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Shimmering Confetti}{\instSymb } }{  \spellEntry{Eternal Flame}{\instSymb } }{  \spellEntry{Smoke Daggers}{\instSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Silver Shield}{\instSymb } }{  \spellEntry{Smokescreen}{\instSymb } }{  \spellEntry{Vanish Object}{\instSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }
	}
 ~ 

}

\schoolTables{Dark Arts}
{
	\discTable{Necromancy}
	{
 		\spellRow{  \spellEntry{Envelop in Shadows}{\instSymb } }{  \spellEntry{Command Undead}{\instSymb } }{  \spellEntry{Blight}{\instSymb } }{  \spellEntry{Barrier of Blood}{\wardSymb } }{  \spellEntry{Blood Moon}{\ritSymb } }{  \spellEntry{Burning Blood}{\concSymb } }{  \spellEntry{Army of the Dead}{\ritSymb } }

 		\spellRow{  \spellEntry{Instil Terror}{\instSymb } }{  \spellEntry{Herpo\apos{}s Bone Blight}{\instSymb } }{  \spellEntry{Drain Life}{\instSymb } }{  \spellEntry{Fiendfyre}{\instSymb } }{  \spellEntry{Contagion}{\instSymb } }{  \spellEntry{Fatal Bolt}{\instSymb } }{  \spellEntry{Soulsnare}{\instSymb } }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Puppets of Flesh}{\ritSymb } }{  \spellEntry{Fatiguing Force}{\instSymb } }{  \spellEntry{Pain Beyond Measure}{\concSymb } }{  \spellEntry{Enthrall}{\instSymb } }{  \spellEntry{Transcend Mortality}{\ritSymb } }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Vicious Slash}{\instSymb } }{  \spellEntry{Hellish Light}{\instSymb } }{  \spellEntry{Plague of Insects}{\instSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{ \emptySpell{} }{  \spellEntry{Necrosis}{\instSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }
	}
 ~ 

	\discTable{Occultism}
	{
 		\spellRow{  \spellEntry{Blood Pact}{\ritSymb } }{  \spellEntry{Equilibrium of Mind \& Body}{\ritSymb } }{  \spellEntry{Abyssal Jet}{\concSymb } }{  \spellEntry{Infernal Ambush}{\instSymb } }{  \spellEntry{Commune with the Dead}{\ritSymb } }{  \spellEntry{Coven\apos{}s Protection}{\ritSymb } }{  \spellEntry{Sacrifice\apos{}s Shield}{\wardSymb } }

 		\spellRow{  \spellEntry{Draw Power}{\ritSymb } }{  \spellEntry{Ghostly Presence}{\concSymb } }{  \spellEntry{Demoncall}{\instSymb } }{  \spellEntry{Solidify Ghost}{\ritSymb } }{  \spellEntry{Dreamscape}{\ritSymb } }{  \spellEntry{Unbreakable Vow}{\ritSymb } }{  \spellEntry{Universal Tear}{\ritSymb } }

 		\spellRow{  \spellEntry{Unkownable Attack}{\instSymb } }{  \spellEntry{Shadowsight}{\concSymb } }{  \spellEntry{Demonic Command}{\instSymb } }{  \spellEntry{Voidsphere}{\concSymb } }{  \spellEntry{Summoning Circle}{\wardSymb } }{ \emptySpell{} }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Shroud of Darkness}{\instSymb } }{  \spellEntry{Elder Knowledge}{\ritSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }

 		\spellRow{ \emptySpell{} }{  \spellEntry{Unfathomable Visage}{\instSymb } }{  \spellEntry{Will\minus{}O\apos{}\minus{}the\minus{}Wisp}{\instSymb } }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }{ \emptySpell{} }
	}
 ~ 
...
\spell{
	name = Abyssal Jet, school = Dark Arts, discipline = Occultism, type = Focus, level =Novice, range =Close, incant = sucus infernum, noDur = 1, higher = Gain an additional 2d4 necrotic damage for every additional spell\minus{}level used to cast this spell.,noResist =1, negation = Blockable  and Dodgeable,effect =A pencil\minus{}thin jet of inky black fluid emerges from the end of your wand up to a distance of 2m. Whilst maintaining concentration you may move and rotate yourself to change which beings are caught in the line\comma{} but damage is only dealt to targets who have the beam focussed on them for at least a major action. 

A being which falls into this region must succeed in dodging\comma{} or take 4d4 necrotic damage\comma{} and half as much again on the next turn.
}


\spell{
	name = Acidic Burst, school = Maledictions, discipline = Hex, type = Instant, level =Novice, range =Wandtip, incant = ambustum, duration = 20 seconds,higher = The acid damage increase by 1d6 per turn for every additional spell\minus{}level dedicated to the casting.,resist = Observation, noBlock = 1, effect =Fills a cube of size 4m with an acidic cloud that does 2d6 + 1 acid damage once per turn to all beings which spend any time within the cloud every turn\comma{} until the end of the spell duration. Any being which is within the cloud at the moment it is summoned may attempt to Resist to hold their breath\comma{} and hence negate the damage taken on their first turn within the cloud.
...
\spell{
	name = Almighty Deluge, school = Charms, discipline = Elemental, type = Instant, level =Master, range =Close, incant = chimeros, noDur = 1, noHigh = 1, noResist =1, negation = Dodgeable,effect =You summon a truly gargantuan jet of water\comma{} which you make into either needle\minus{}thin jet\comma{} or a hammer\minus{}blow blast. If it makes contact with a target\comma{} deals 8d12 bludgeoning or piercing damage (your choice).
}
...
\spell{
	name = Arcane Surgery, school = Recuperation, discipline = Healing, type = Ritual (5 minutes), level =Expert, range =Wandtip, incant = ossium emendo, noDur = 1, noHigh = 1, noResist =1, noBlock = 1, effect =A powerful surge of healing magic knits together broken bones\comma{} soothes deep\minus{}tissure burns and drives out poisons.

Removes any \textit{Broken Bone}\comma{} {\it Poisoned: Severe}\comma{} {\it Hypoxia}\comma{} {\it Burned: Severe}\comma{} {\it Frostbitten: Severe} status effects\comma{} as well as any associated \textit{Serious Injury} status effects. The target is placed into stasis for the duration of the ritual\comma{} so time\minus{}dependent effects from these status effects are paused whilst the ritual is ongoing\comma{} even if the casting is unsuccessful. 

If an active spell is preventing these spells\comma{} or reapplying them immediately\comma{} you must upcast this spell to the  equal level in order to end the effect. 

This spell does not work on beings which do not have a serious or debilitating status condition.
}
...
\spell{
	name = Arctic Blast, school = Maledictions, discipline = Hex, type = Instant, level =Expert, range =Close, incant = gelidus, noDur = 1, higher = \additional{2d6}{Cold},resist = Vitality, noBlock = 1, effect =A cylinder of radius 5m and height 2m around the target is blasted with freezing air\comma{} causing the temperature to fall by 150 degrees celsius. 

Those caught in the region take 4d6 of cold damage\comma{} and apply the mild Frostbite status effect. Resist for half damage and to negate the status effect.
}
...
Your astral self is undetectable to most living beings\comma{} but appears almost identical to your physical form\comma{} including astral copies of all your equipment. Your astral form has 1d4 HP per character level\comma{} but can only interact with other entities on the Astral Realm and effects which explicitly state they effect the astral realm. 
...
\spell{
	name = Babbling, school = Illusion, discipline = Psionics, type = Instant, level =Novice, range =Close, incant = longardo, duration = 2 minutes,noHigh = 1, resist = Willpower, noBlock = 1, effect =On a failed Resist\comma{} the target begins babbling incoherently and without control. 
...
\spell{
	name = Barrier of Blood, school = Dark Arts, discipline = Necromancy, type = Ward (1 minute), level =Adept, range =Wandtip, incant = confusangui, noDur = 1, noHigh = 1, noResist =1, noBlock = 1, effect =Use blood to draw warding runes onto an object or person. Erects a swirling\comma{} red barrier which is impenetrable\comma{} though not opaque or soundproof. Barrier absorbs up to 20d6 damage\comma{} but takes triple damage from Celestial damage. 
Each individual{\apos}s blood can only be used once for blood magic.
}


\spell{
	name = Bat Bogey Hex, school = Maledictions, discipline = Hex, type = Instant, level =Novice, range =Sight, incant = vespernasum, noDur = 1, higher = This spell summons an additional bat\minus{}bogey \forEvery{}.,noResist =1, negation = Blockable  and Dodgeable,effect =Causes the mucus in the target{\apos}s nose to gain sentience\comma{} take the form of two tiny bats\comma{} and then perform a kamikaze attack on their former host.

Each bat\minus{}bogey deals 1d10 force damage.
}


\spell{
	name = Beartrap, school = Recuperation, discipline = Warding, type = Ward, level =Novice, range =Close, incant = ursa dentes, duration = 5 days,higher = The ward gains an additional 1d8 piercing damage for every additional spell\minus{}level dedicated to casting it.,resist = Reflex, noBlock = 1, effect =Craft a powerful ward of invisible force and lay in on a flat surface\comma{} such as the fwalls or floor\comma{} which it adheres to. The trap has a radius up to 2m.

When a being crosses over the threshold of the ward\comma{} or touches any part of it\comma{} the ward slams shut\comma{} doing 2d8 worth of piercing damage and applying the Trapped status effect. A successful resist takes half damage and nullifies the Trapping effect.
}
...
\spell{
	name = Black Dragon\apos{}s Fury, school = Maledictions, discipline = Hex, type = Focus, level =Expert, range =Close, incant = draco flammor, noDur = 1, higher = \additional{2d6}{Force},resist = Power, noBlock = 1, effect =A torrent of black\comma{} crackling energy erupts from the tip of your wand in a cone 3 metres in front of the caster\comma{} devastating everything in its path. 

This spell deals 5d6 Force damage to all targets caught in the region\comma{} halved on a successful Resist.
}


\spell{
	name = Blade Wall, school = Recuperation, discipline = Warding, type = Ward, level =Adept, range =Wandtip, incant = heus nocivious, duration = 30 minutes,higher = The effective\minus{}HP of the wall increases by 40 \forEvery{}.,resist = Arcane, noBlock = 1, effect =Create an impenetrable\comma{} opaque warded region up to 10m long and 2m tall in a space that you can see. 

This wall is composed of swirling\comma{} semi\minus{}corporeal magical blades that do 3d8 slashing damage to any creature that touches it\comma{} halved on a successful Resist. The wall can withstand 50 points of damage before disintegrating.
}
...
\spell{
	name = Burning Blood, school = Dark Arts, discipline = Necromancy, type = Focus, level =Master, range =Close, incant = zesto sidero, noDur = 1, noHigh = 1, noResist =1, negation = Blockable  and Dodgeable,effect =You corrupt the very blood of your foe\comma{} turning it into a burning acid\comma{} or molten lead. Whilst you maintain focus\comma{} the target takes 6d12 acid or fire damage (your choice).
}


\spell{
	name = Burst of Frost, school = Charms, discipline = Elemental, type = Instant, level =Novice, range =Close, incant = isti, noDur = 1, higher = Gain an additional 1d12 Cold damage for every additional spell level dedicated to casting this spell.,noResist =1, negation = Blockable  and Dodgeable,effect =The air around the tip of your wand freezes\comma{} condensing the surrounding water vapour into a tiny globe of ice\comma{} which launches towards your target. If it hits\comma{} the globe explodes doing 2d12 Cold damage.
}
...
The audible alarm produces an ear\minus{}splitting screech when the perimiter is breached. The sound is loud enough to be heard over large distances and through thick walls.
}


\spell{
	name = Ceremony of Life, school = Recuperation, discipline = Healing, type = Ritual (10 minutes), level =Beginner, range =Wandtip, noIncant = 1, noDur = 1, noHigh = 1, noResist =1, noBlock = 1, effect =You perform a quasi\minus{}religious ritual\comma{} in which you call upon a positive celestial power\comma{} and request the ability to repel and destroy the undead. Choose from the following effects:

\begin{spellitemize}
\boldItem{Holy Infusion}{You infuse a quantity of water with celestial energy\comma{} producing 5 vials of Holy Water}
\boldItem{Seeker of Undeath}{For one day\comma{} a targeted being has advantage on all accuracy checks against Undead beings.}
\boldItem{Protection from Profanity}{Target the corpses of up to 10 beings. For 1 week\comma{} these beings cannot be raised as Undead\comma{} or otherwise animated.}
\boldItem{Fear of God}{You focus the energy into a small token. At some point within the next day you may hold this token aloft\comma{} causing it to explode in a celestial light. All undead within 15m must succeed on a Willpower Resist or become {\it Terrified} of you.}
\end{spellitemize}
}
...
If the bolt strikes the target\comma{} they take 10d10+10 force\comma{} electric or celestial damage.
}
...
\spell{
	name = Checkup, school = Recuperation, discipline = Healing, type = Instant, level =Beginner, range =Wandtip, incant = dispungo, noDur = 1, noHigh = 1, noResist =1, noBlock = 1, effect =Enquire as to the health status of the target\comma{} find out their remaining HP\comma{} as well as any status effects\comma{} illnesses\comma{} curses or diseases they currently posses.
}
...
\spell{
	name = Command Undead, school = Dark Arts, discipline = Necromancy, type = Instant, level =Beginner, range =Close, incant = mandatum, duration = 1 hour,noHigh = 1, resist = Evil, noBlock = 1, effect =You direct your evil intent towards an undead being\comma{} and attempt to bring it under your control. 

If the target is under the control of another spellcaster then the it is the master which performs the Resist\comma{} otherwise it is the target. On a failed Resist\comma{} the Undead now considers you its master and will obey any and all commands that you give it. If the Resist is successful\comma{} you cannot target this undead creature again for 24 hours/

If the target has an Intelligence above 12\comma{} it may repeat the Resist check at the end of every combat cycle to attempt to break free.
}


\spell{
	name = Commanding Word, school = Illusion, discipline = Psionics, type = Instant, level =Beginner, range =Close, incant = dictum, duration = 3 seconds,noHigh = 1, resist = Willpower, noBlock = 1, effect =You speak a single\minus{}word command\comma{} layering your magic\minus{}infused willpower into it. On a failed Resist\comma{} the target must use the entirety of their next turn to carry out this command. This spell fails if the target does not understand the command\comma{} or if the command is directly harmful. 

The target will execute the command to the best of its understanding and ability: if commanded to flee\comma{} it will use its entire action to move as far as possible\comma{} if commanded to halt it takes no actions other than those needed to maintain its current position.
}
...
\spell{
	name = Contact Shock, school = Charms, discipline = Elemental, type = Instant, level =Trivial, range =Wandtip, incant = electrum, noDur = 1, higher = \additional{1d6}{Electric},noResist =1, noBlock = 1, effect =Charge the tip of your wand with electrical energy and discharge it on contact. Does 1d6 electrical damage on contact\comma{} and also fries any electrical equipment it comes into contact with.
}
...
\spell{
	name = Crackling Fist, school = Maledictions, discipline = Hex, type = Instant, level =Novice, range =Wandtip, incant = grothia, noDur = 1, higher = \additional{2d6}{Electric},noResist =1, negation = Blockable  and Dodgeable,effect =As you ram your wandtip into an opponent\comma{} performing a melee spell attack\comma{} an enormous fist\minus{}shaped field of energy explodes into the target\comma{} dealing 3d6 electric damage and 2d6 bludgeoning damage.
}
...
\spell{
	name = Crystal Gazing, school = Divination, discipline = Temporal, type = Ritual (1 minute\comma{} requires ), level =Beginner, range =Self, incant = Gazing, noDur = 1, noHigh = 1, noResist =1, noBlock = 1, effect =Gaze into your crystal ball\comma{} and ask a question of the cosmos. You will receive a yes or a no answer to any question you ask.
}


\spell{
	name = Crystalrot, school = Maledictions, discipline = Curse, type = Instant, level =Master, range =Wandtip, incant = rissalus, noDur = 1, noHigh = 1, resist = Conviction, negation = Blockable  and Dodgeable,effect =With a touch infect the target with a devilish progressive curse. A crystalline shell begins to grow and spread over their skin\comma{} working its way out from the point of contact and digging into their flesh.

At the end of every turn\comma{} the target must perform a Resist check. On completing three successful Resists\comma{} their mind rejects the crystalline roots worming into their brain\comma{} the crystal shatters and the spell is broken. 

As the curse progresses and the crystals grow over their body\comma{} they suffer from the following cumulative effects:
\begin{rndtable}{c  p {4 cm}}
Infection Time& Effect \\
0\minus{}2 cycles & Disadvantage on \attFin{} checks \\
3\minus{}5 cycles& \attFin{} value decreases by 1 point every cycle. \\
7\minus{}10 cycles & Susceptible to bludgeoning damage \\
11\minus{}15 cycles & Movement speed reduced by 1 metre per round \\
16 + cycles & Completely immobilised and {\it Incapacitated}. Can only take {\it Resist} actions. 
\end{rndtable}
}


\spell{
	name = Cure the Masses, school = Recuperation, discipline = Healing, type = Instant, level =Ascendant, range =Close, incant = episkey maxima, noDur = 1, noHigh = 1, noResist =1, noBlock = 1, effect =Roll 10d10\comma{} and multiply this result by 10 (alternatively\comma{} use the average result of 500). 
...
\spell{
	name = Cursed Step, school = Maledictions, discipline = Curse, type = Instant, level =Expert, range =Close, incant = gradus maledictus, duration = 1 day,noHigh = 1, resist = Acrobatics, negation = Blockable  and Dodgeable,effect =When this spell hits the target\comma{} their very presence in an area is enough to leave a cursed aura. 
...
\spell{
	name = Dancing Bolt, school = Charms, discipline = Elemental, type = Instant, level =Novice, range =Close, incant = arka gola, noDur = 1, higher = Gain an additional burst \forEvery{}.,resist = Reflex, noBlock = 1, effect =You produce two bursts of fire spiral out from your wand and spiral through the air\comma{} seeking out your targets. You may choose to target one being that you can see within range\comma{} or direct each burst to strike a different target. 

Each bolt deals 2d4+2 fire damage\comma{} halved on a successful Resist.
}
...
\spell{
	name = Delusion, school = Illusion, discipline = Psionics, type = Instant, level =Adept, range =Close, incant = falasarium, duration = 8 hours,noHigh = 1, resist = Conviction, noBlock = 1, effect =You target a sapient being and fill their minds with new ideas and concepts. If target fails a Resist check\comma{} the caster may make them believe one piece of information\comma{} which they will believe to be irrefutably true. The delusion and may not incur excessive self\minus{}harm when followed\comma{} but may take any form you desire.

For the remained of the duration of the spell\comma{} the target will act according to their newfound belief\comma{} ignoring any contradiction with their previously held convictions and evidence to the contrary.
}


\spell{
	name = Demoncall, school = Dark Arts, discipline = Occultism, type = Instant, level =Novice, range =Sight, incant = profundum, duration = 30 minutes,higher = For every additional spell\minus{}level dedicated to casting this spell\comma{} the maximum MoM rating of a demon that you can summon increases by 1. Demons with ratings IV and above can take more complex commands – up to a single phrase.,noResist =1, noBlock = 1, effect =Convince a demon (MoM rating II or less) to break through the walls between reality and come to your aid\comma{} opening a rift at a spot you choose within 10m of your position. You may choose the type of demon from those that you have previously studied or encountered.
...
\spell{
	name = Disintegration, school = Maledictions, discipline = Hex, type = Instant, level =Ascendant, range =Sight, incant = reducto, noDur = 1, noHigh = 1, noResist =1, negation = Blockable  and Dodgeable,effect =If the spell makes contact with matter\comma{} causes it to instantly disintegrate. Living beings take 10d10 + Hex Spellcasting modifier worth of force damage\comma{} halved on a successful Block or negated on a Dodge.
}
...
\spell{
	name = Distant Shield, school = Recuperation, discipline = Warding, type = Instant, level =Adept, range =Close, incant = protego discero, noDur = 1, noHigh = 1, noResist =1, noBlock = 1, effect =You summon an {\it Arcane Shield} to protect another being you can see within range. 

Whenever an attack is performed against them whilst the shield is active\comma{} roll 2d4 +2 and add this value to theit Resist check or their Block value\comma{} as appropriate. If a successful Resist would limit the amount of damage taken\comma{} negate it entirely instead. 

If the target fails to Resist\comma{} or the Accuracy exceeds the augmented Block value\comma{} the shield crumples and the spell is ended. The spell which broke the shield is then applied to at half damage\comma{} with any other effects unmodified. Any other spells which strike after this act as normal.
}
...
\spell{
	name = Drain Life, school = Dark Arts, discipline = Necromancy, type = Instant, level =Novice, range =Wandtip, incant = tenebrosa sudarium, noDur = 1, higher = Increase the draining effect by 1d10 \forEvery.,resist = Conviction, noBlock = 1, effect =Channel vampric energy through your wand\comma{} to drain the life from a helpless individual. Drain 2d10 + Evil modifier HP from an {\it Incapacitated} target (halved on a successful Resist)\comma{} and restore half of this value to your own HP.
}
...
The earthquake also spawns 1d4 Master\minus{}level {\it Yawning Fissures} at locations chosen by the caster (see the relevant spell). 
...
\spell{
	name = Elder Knowledge, school = Dark Arts, discipline = Occultism, type = Ritual (30 minutes), level =Novice, range =Self, incant = vetitum scenticus, noDur = 1, noHigh = 1, noResist =1, noBlock = 1, effect =Attune your mind to the Eldritch Domains. The Demons of the Deep will answer one of your questions\comma{} but the answers might drive you mad.
The question must be said out loud for all to hear\comma{} but the answer may be written down and passed to your privately.
}


\spell{
	name = Electrical Arc, school = Charms, discipline = Elemental, type = Focus, level =Expert, range =Close, incant = electrum maxima, noDur = 1, higher = \additional{2d8}{Electrical},noResist =1, negation = Blockable,effect =Whilst you maintain Focus\comma{} a bolt of energy arcs from the end of your wand\comma{} doing 5d8+2 electrical damage per turn.
}
...
\spell{
	name = Endure Environment, school = Recuperation, discipline = Healing, type = Instant, level =Novice, range =Wandtip, incant = omnium, duration = 1 day,noHigh = 1, noResist =1, noBlock = 1, effect =Choose up to 5 targets and protect them from the ravages of the environment. 

Protected beings can comfortably exist in ambient temperatures in the range \minus{}40  to 50 celsius\comma{} and are unaffected by heavy rain and other weather phenomena. The targets are not protected against fire and cold damage\comma{} however.
}
...
\spell{
	name = Envelop in Shadows, school = Dark Arts, discipline = Necromancy, type = Instant, level =Trivial, range =Sight, incant = malusangui, noDur = 1, higher = Gain 1d8 additional necrotic damage for each additional spell level.,noResist =1, negation = Blockable  and Dodgeable,effect =You concentrate\comma{} and the nearby shadows flock to your wand\comma{} curling around like an evil candy floss\comma{} before launching themselves at your target dealing 1d8 + 1 necrotic damage.
}


\spell{
	name = Equilibrium of Mind \& Body, school = Dark Arts, discipline = Occultism, type = Ritual (1 minute), level =Beginner, range =Self, incant = exbibo, noDur = 1, noHigh = 1, noResist =1, noBlock = 1, effect =You attune your mind to one of the higher planes\comma{} perhaps Machina: the plane of order\comma{} and contact a being which values order\comma{} neatness and equality above all else. 

Transfer an equal amount of FP into HP\comma{} or HP into FP until the values become equal. If your HP and FP values are already equal\comma{} this spell has no effect. You cannot cast this spell again until you have completed a long rest.
}


\spell{
	name = Erupting Earth, school = Charms, discipline = Elemental, type = Instant, level =Expert, range =Close, incant = purskama, noDur = 1, higher = \additional{2d10}{bludgeoning},noResist =1, negation = Dodgeable,effect =Target a being standing on a patch of earth or mud. The ground underneath them explodes upwards in a violent eruption of loose stones and tumultuous ground\comma{} dealing 5d10 bludegoning damage.
}
...
\spell{
	name = Exploding Missile, school = Maledictions, discipline = Hex, type = Instant, level =Adept, range =Close, incant = bombarda, noDur = 1, higher = \additional{1d12}{},noResist =1, negation = Blockable  and Dodgeable,effect =A small missile launches from the end of your wand and explodes on contact with the target\comma{} dealing 3d12 damage distributed between fire and concussive however you choose.
}
...
\spell{
	name = Far\minus{}Flung Flames, school = Charms, discipline = Elemental, type = Instant, level =Novice, range =Sight, incant = ignis, noDur = 1, higher = \additional{1d6}{Fire},resist = Logic, noBlock = 1, effect =You wave your wand in a complicated pattern\comma{} and an area of the target up to 1m squared bursts into flames\comma{} and begins to expand over the rest of the target. 

Ignited beings take 3d6 fire damage per turn\comma{} and the effect lasts until they come into contact with sufficient water or wind to extinguish the flames\comma{} or they pass a DV 10 Resist check\comma{} and voluntarily use a minor movement to take the {\it Prone} status. The resist check is performed when the spell hits\comma{} and then at the end of each subsequent turn.
}


\spell{
	name = Fatal Bolt, school = Dark Arts, discipline = Necromancy, type = Instant, level =Master, range =Sight, incant = avada kedavra, noDur = 1, noHigh = 1, noResist =1, negation = Blockable  and Dodgeable,effect =If the spell makes contact with the target\comma{} kills them instantly. 
...
\spell{
	name = Fatiguing Force, school = Dark Arts, discipline = Necromancy, type = Instant, level =Novice, range =Sight, incant = dulcis mortem, noDur = 1, noHigh = 1, resist = Strength, noBlock = 1, effect =A wave of exhaustion washes over your target. They must succeed on a Resist check\comma{} or increase their exhaustion level by 1.
...
\spell{
	name = Fiendfyre, school = Dark Arts, discipline = Necromancy, type = Instant, level =Adept, range =Sight, incant = pyrkagius, duration = 1 hour,higher = \additional{1d8}{fire},noResist =1, negation = Blockable  and Dodgeable,effect =Summons a cursed fire that consumes everything that it touches\comma{} and actively seeks to destroy living beings as if it were a living being telepathically linked to the caster. The caster may direct the fire may send out up to 1d4 tendrils per turn to strike at a target (performing an accuracy check for every atack)\comma{} doing 3d8 fire damage to all it touches.
...
\spell{
	name = Fiery Whip, school = Charms, discipline = Elemental, type = Instant, level =Master, range =Close, incant = ignellum, noDur = 1, higher = When cast as an Ascendant\minus{}level spell\comma{} trapped individuals take 5d6 damage per turn.,resist = Strength, negation = Blockable  and Dodgeable,effect =You summon a thin trail of fire from the end of you wand\comma{} which you can then use as a whip\comma{} performing a melee attack using your Elemental modifier (if you are proficient in Exotic weapons\comma{} you may add your Expertise modifier again\comma{} even if you have already added it). 

Any target hit by your flaming whip takes 6d12 fire damage\comma{} and you may direct the whip such that it wraps around them\comma{} rendering them {\it Trapped} until they successfully resist at the end of each turn. A trapped individual takes a further 3d6 Fire damage per turn\comma{} unless they escape using a dedicated major action\comma{} rather than waiting for the end\minus{}of\minus{}turn resist. 
...
\spell{
	name = Fireball, school = Charms, discipline = Elemental, type = Instant, level =Adept, range =Sight, incant = confringo, noDur = 1, higher = \additional{2d6}{Fire},noResist =1, negation = Blockable  and Dodgeable,effect =Launches a fireball at the target\comma{} which explodes on contact for 3d6+3 Fire Damage on all targets within 2m of the target. This effect is negated on a successful dodge\comma{} and halved on a successful block.
}


\spell{
	name = Flame Freezing, school = Recuperation, discipline = Warding, type = Ward, level =Beginner, range =Wandtip, incant = glaciagnis, duration = 1 hour,noHigh = 1, resist = Power, noBlock = 1, effect =Causes non\minus{}magical fire to feel lightly cool and tickle the warded subject\comma{} rather than burning them. 
...
\spell{
	name = Freebreathe, school = Recuperation, discipline = Healing, type = Instant, level =Trivial, range =Wandtip, incant = Anapneo, noDur = 1, noHigh = 1, noResist =1, noBlock = 1, effect =The target has their airways cleared\comma{} allowing them to breath freely and negating any choking effects.
}
...
\spell{
	name = Fury, school = Illusion, discipline = Psionics, type = Instant, level =Adept, range =Sight, incant = irafors, duration = 30 seconds,noHigh = 1, resist = Empathy, noBlock = 1, effect =Target performs a Resist check\comma{} if they fail\comma{} target flies into a mindless rage and begins attacking all those around them\comma{} taking the {\it Enraged} status effect.
}
...
\spell{
	name = Ghostly Presence, school = Dark Arts, discipline = Occultism, type = Focus, level =Beginner, range =Close, incant = larvus, noDur = 1, higher = You may summon an additional presence at a different location \forEvery{}.,resist = Attention, noBlock = 1, effect =You summon an ethereal\comma{} otherworldly presence which presses into the fabric of reality\comma{} causing the hairs to rise on the back of your arms. The being `appears’ in a region of space that you can see within range. 

Though the presence is invisible and incorporeal\comma{} on a failed Resist check all beings within 2m of the presence become convinced that there is someone nearby\comma{} and take the {\it Distracted} status next turn.
}
...
\spell{
	name = Glimpse Future, school = Divination, discipline = Temporal, type = Instant, level =Novice, range =Close, incant = posterus, duration = 10 seconds,higher = You may target an additional individual \forEvery{}.,noResist =1, noBlock = 1, effect =You choose a sapient being you can see within range\comma{} and show it one of many possible futures. 

The target may then choose to take one of the following effects for the duration of the spell:

\begin{itemize}
\item Advantage on all Reflex\comma{} Speed and Acrobatics checks 
\item Advantage on all accuracy rolls 
\item +4 bonus to dodge
\end{itemize}
}
...
This field halts any physical object that touches or spends any part of their turn within it. Objects in flight drop to the ground\comma{} as if the {\it Halt} spell had been cast on them. Beings attempting which touch the field must Resist or have their speed halved this turn cycle.
}


\spell{
	name = Healing Barrage, school = Recuperation, discipline = Healing, type = Instant, level =Master, range =Close, incant = lavi thera maxima, noDur = 1, noHigh = 1, noResist =1, noBlock = 1, effect =Cause up to 7 bolts of healing energy shoot from your wand and into your targets\comma{} healing them from afar. You can direct the bolts to strike at one target\comma{} or cause them all to strike into one. 

Each bolt restores 6d8 + Healing spellcasting modifier.
}


\spell{
	name = Healing Lance, school = Recuperation, discipline = Healing, type = Instant, level =Novice, range =Close, incant = lavi thera, noDur = 1, higher = Heals an additional 2d4 \forEvery{}.,noResist =1, noBlock = 1, effect =A bolt of healing energy bursts from your wand a shoots towards your target\comma{} healing them for 3d4 health points.
}


\spell{
	name = Heavenly Arsenal, school = Maledictions, discipline = Hex, type = Instant, level =Ascendant, range =Sight, incant = ouranios, duration = 1 minute,higher = 15,resist = Power, noBlock = 1, effect =As you cast this spell\comma{} 7 motes of heavenly light and sit above your head like a celestial halo. Over the next minute\comma{} you may choose to fire any number of these motes at a target of your choice as an instant action once per turn.

Each mote does 3d4+2 damage\comma{} negated on a successful Resist. The type of damage is determined by rolling a d10:
\begin{spellitemize}
\item 1: Fire
\item 2: Cold
\item 3: Force
...
\spell{
	name = Herpo\apos{}s Bone Blight, school = Dark Arts, discipline = Necromancy, type = Instant, level =Beginner, range =Close, incant = anasteos, noDur = 1, higher = \additional{1d10}{necrotic},resist = Empathy, negation = Blockable  and Dodgeable,effect =A vile beam of energy shoots from your wand into a target\comma{} dealing 1d10 necrotic damage. 

If this spell causes the target to fall into the {\it Critical Condition} status\comma{} they must perform a final Resist check as their very skeleton begins to animate itself and tear free. On a success they are fine\comma{} but on a failure their skeleton breaks free and enters your service as if you had cast {\it Puppets of Flesh}.
}
...
\spell{
	name = Hovering Globe, school = Charms, discipline = Elemental, type = Instant, level =Beginner, range =Self, incant = globus, duration = 1 minutes,noHigh = 1, noResist =1, noBlock = 1, effect =Summons a glowing orb\comma{}around 5cm in diameter that hovers above the caster\apos{}s head\comma{} casting bright light for 4m\comma{} and dim light for a further 15m. As a minor action\comma{} the caster may move this light up to 10m in any direction.
}
...
\spell{
	name = Icicle Barrage, school = Charms, discipline = Elemental, type = Instant, level =Expert, range =Close, incant = krystallium, noDur = 1, higher = Gain an additional icicle \forEvery{},noResist =1, negation = Blockable  and Dodgeable,effect =At your command 4 razor sharp shards of ice fling themselves at your target\comma{} performing an accuracy check for each. 

Each shard does 1d6 piercing damage and 1d6 cold damage.
}
...
This means they cannot book\minus{}cast\comma{} and if they attempt to focus on a bit of writing for more than 2 seconds\comma{} they take the {\it confused} status.
}
...
\spell{
	name = Imbibing Rune, school = Recuperation, discipline = Warding, type = Ward, level =Beginner, range =Wandtip, incant = dolus, noDur = 1, noHigh = 1, noResist =1, noBlock = 1, effect =You create a magical ward which absorbs and incorporates additional magical effects into its structure\comma{} storing them for later. 

After casting the rune\comma{} you cast an additional spell that you have memorised as an instantaneous action to imbue the trap with that effect. The effect spell must be of the same level or lower as that used to cast this spell. You may slightly modify the effects of the spell to suit your needs\comma{} with the GM\apos{}s consent.

If this imbuement is successful\comma{} you create a hidden magical trap of radius 50cm on any solid surface you can see within range.
...
\spell{
	name = Immolation, school = Charms, discipline = Elemental, type = Instant, level =Ascendant, range =Close, incant = uro, noDur = 1, noHigh = 1, resist = Power, negation = Dodgeable,effect =A small ember drifts lazily from the end of your wand\comma{} and latches onto your target\comma{} igniting a small part of the target. Once it has taken root\comma{} nothing can extinguish this fire until it either runs out of fuel\comma{} or out of air. No magical intervention known to wizardkind can end its life before one of these conditions is met. 
...
The fire may be moved using the {\it Control Fire} spell\comma{} but only when cast at an Ascendant Level \comma{} and even then requires a Power Resist to successfully remove the fire.
}
...
\spell{
	name = Incessant Whispers, school = Illusion, discipline = Psionics, type = Focus, level =Beginner, range =Sight, incant = rastarum, noDur = 1, higher = \additional{2d4}{Psychic},resist = Logic, noBlock = 1, effect =The target hears a voice in their ear whispering maddening words that slowly drive them insane. The target performs a Resist check at the end of every turn to break the spell\comma{} but whilst the spell remains active the target takes 2d4+1 psychic damage per turn.
}


\spell{
	name = Incinerating Expanse, school = Charms, discipline = Elemental, type = Focus, level =Expert, range =Close, incant = ustulo, duration = Y,higher = \additional{2d6}{Fire},noResist =1, negation = Blockable,effect =Enormous dragonlike tendrils of flame rip from the end of your wand\comma{} seeking out and incinerating everything in a cone up to 5 metres in front of the caster. 

All beings caught in this radius take 5d6+3 fire damage. This damage is halved on a successful Block and negated on a successful dodge.
}


\spell{
	name = Infernal Ambush, school = Dark Arts, discipline = Occultism, type = Instant, level =Adept, range =Close, incant = gehenna, noDur = 1, higher = \additional{1d10}{},noResist =1, negation = Dodgeable,effect =Targeting the ground beneath the feet of your foes\comma{} you summon powerful energies to rise out of the Earth\comma{} dealing 3d10 + 2 fire or cold damage to the target.
}
...
\spell{
	name = Instil Terror, school = Dark Arts, discipline = Necromancy, type = Instant, level =Trivial, range =Close, incant = timeant, duration = 4 minutes,noHigh = 1, resist = Willpower, noBlock = 1, effect =On a failed Resist\comma{} the target becomes {\it Terrified} of the caster.
}
...
\spell{
	name = Ironwall, school = Recuperation, discipline = Warding, type = Ward, level =Expert, range =Wandtip, incant = ferromurrum, duration = 1 day,higher = Gain an additional 60 HP for the Ironwall \forEvery{}.,noResist =1, noBlock = 1, effect =Forms a shielded sphere around an area up to 5m in radius stretching upwards and down under the ground.

The sphere absorbs can absorb up to 120 points of damage before it is destroyed. The Ironwall is impenetrable\comma{} opaque and soundproof\comma{} and is two\minus{}way. The caster may choose to allow beings to pass through the field\comma{} but no objects or spells can pass through the field until it is deactivated by the caster as a minor action\comma{} or it is destroyed.
}
...
\spell{
	name = Jinx, school = Maledictions, discipline = Curse, type = Instant, level =Beginner, range =Sight, incant = nullicus, duration = 1 minute,noHigh = 1, resist = Power, noBlock = 1, effect =You place a minor curse onto a targeted being. You may choose the effect of the curse:
\begin{spellitemize}
\item \boldItem{Weakened}{The target takes disadvantage on melee accuracy checks}
\item \boldItem{Clumsy}{The target takes disadvantage on ranged accuracy checks}
\item \boldItem{Twisted Tongue}{Force the target to perform spellcasting checks for all spells\comma{} and take disadvantage on all Charisma checks.}
\item \boldItem{Impotent}{The target takes a 1d4 penalty to their Arcane Subjugation value}
\end{spellitemize}

On a successful Resist\comma{} the effect is negated\comma{} but the next Resist check they perform is done with disadvantage.
}
...
You retain your \attInt{}\comma{} \attSpr{} and \attEvl{} statistics and associated proficiencies (as well as all spellcasting abilities and archetype features)\comma{} but otherwise you now reside in the body of your ally\comma{} and take their statistics. You may then take actions as if you were them until you decide to switch back\comma{} or the spell is ended.  

When the spell ends\comma{} your soul always returns to your original body. If either being drops to 0HP whilst the change is in place\comma{} you instantly switch back into your original bodies\comma{} the inhabitant of the 0HP body then takes the {\it Critical Condition} status and begins fighting for their life.
}
...
\spell{
	name = Lightning Bolt, school = Charms, discipline = Elemental, type = Instant, level =Adept, range =Sight, incant = baubilious, noDur = 1, higher = \additional{2d6}{Electrical},resist = Vitality, negation = Blockable  and Dodgeable,effect =Releases a bolt of lightning from the end of your wand. 
Lightning can initiate fires\comma{} provide electrical current or can be used directly in combat\comma{} where it deals 5d6 + 2 electric damage. Targets struck by lightning must succeed in a Resist check\comma{} or be blinded and deafened next turn.
}
...
\spell{
	name = Major Curse, school = Maledictions, discipline = Curse, type = Ritual (10 minutes), level =Expert, range =Sight, incant = maledicto, noDur = 1, noHigh = 1, resist = Power, noBlock = 1, effect =Casts a permanent\comma{} powerful curse on a target being\comma{} object or location that you can see within range. Some examples of curses could be:

\begin{itemize}
\item A target begins weeping blood (effectively {\it Blinding} them) whenever a certain trigger occurs.
\item A shadowy force haunts the target attempting to enter their body\comma{} dealing 3d10 necrotic damage whenever they take slashing or piercing damage. 
\item Curse a room with an aura which causes 4d8 psychic damage when you enter
\item An item which causes a target to go insane whilst holding it\comma{} but which cannot voluntarily be released
\end{itemize}

These are examples\comma{} and you are encouraged to come up with your own variations\comma{} though they must be commensurate with the casting level of this spell\comma{} and the GM has a veto. Curses should be able to be Resisted either at the point of the cursing\comma{} or whenever the effect is triggered (as appropriate). Be inventive!
}


\spell{
	name = Major Healing, school = Recuperation, discipline = Healing, type = Instant, level =Expert, range =Wandtip, incant = sana, noDur = 1, higher = Heal an additional 2d10 HP \forEvery{},noResist =1, noBlock = 1, effect =Heals the target of all burns\comma{} frostbite\comma{} poisons and diseases\comma{} temporary blindness\comma{} deafness and paralysis\comma{} regardless of severity. 

In addition\comma{} restore 5d10 + 8 HP to the target.
}
...
\spell{
	name = Mass Delusion, school = Illusion, discipline = Psionics, type = Instant, level =Ascendant, range =Sight, incant = falasarium maxima, duration = 12 hours,noHigh = 1, resist = Conviction, noBlock = 1, effect =You target the up to 10 sapient beings and fill their minds with new ideas and concepts. If a target fails a Resist check\comma{} the caster may make them believe one piece of information\comma{} which they will believe to be irrefutably true. The delusion and may not incur excessive self\minus{}harm when followed\comma{} but may take any form you desire. The suggested delusion is the same to all targets. 

For the remained of the duration of the spell\comma{} the afflicted will act according to their newfound belief\comma{} ignoring any contradiction with their previously held convictions and any evidence to the contrary.
}
...
\spell{
	name = Mass Remedy, school = Recuperation, discipline = Healing, type = Instant, level =Adept, range =Close, incant = enervate maxima, noDur = 1, higher = Heal an additional 2d6 HP \forEvery{}.,noResist =1, noBlock = 1, effect =Target up to 6 living creatures within 10m\comma{} and infuse them with healing energy. 

Each target regains 4d6 HP.
}
...
\spell{
	name = Mercy, school = Recuperation, discipline = Healing, type = Ward, level =Beginner, range =Sight, incant = clementia, duration = 1 day,noHigh = 1, resist = Evil, noBlock = 1, effect =You draw an arcane ward onto a target\comma{} which flares into life when a target is in extreme danger. 

If the subject of the ward falls to 1HP or below\comma{} they are considered a non\minus{}combatant and can only be targeted by beings which successfully Resist the effects of this spell. The ward is destroyed if\comma{} after it is activated the subject engages in hostile activity\comma{} or they are healed above 1HP. Those protected by this spell may be still be by area\minus{}of\minus{}effect attacks centred on other valid targets.
}
...
\spell{
	name = Meteor Strike, school = Maledictions, discipline = Hex, type = Instant, level =Master, range =Sight, incant = bothynus, noDur = 1, higher = When cast as an Ascendant\minus{}level spell\comma{} the meteor deals 5d12 damage which can be divided into Fire and Concussive damage at the caster\apos{}s behest.,resist = Reflex, noBlock = 1, effect =A giant orb of fire and rock slams down into the ground at a targeted point\comma{} releasing a shockwave over a region 10m in radius. All beings in the region take 2d12 fire damage and 2d12 concussive damage\comma{} halved on a successful Resist.
}


\spell{
	name = Mindpurge, school = Illusion, discipline = Bewitchment, type = Instant, level =Adept, range =Wandtip, incant = tergo, noDur = 1, noHigh = 1, noResist =1, noBlock = 1, effect =Select a target and purge their mind of negative emotions and external influences. 

Remove one of the following status effects from the targeted being: {\it Charmed\comma{} Confused\comma{} Enraged} or {\it Terrified}.
}


\spell{
	name = Minefield, school = Recuperation, discipline = Warding, type = Ward, level =Adept, range =Wandtip, incant = denarlium, duration = 1 week,higher = \additional{1d10}{},resist = Observation, noBlock = 1, effect =Lay magical {\it mines} in a 15m radius\comma{} with a 5m radius gap at the centre. You may designate a single safe route through the minefield (a path of width 0.5m). 

If a being touches any part of the minefield other than the path\comma{} the mines explode doinig 3d8 damage of a type of the caster\apos{}s choosing. Each subsequent metre travelled triggers another explosion. Explosions may be Resisted for half damage.
}
...
\spell{
	name = Morgana\apos{}s Greed, school = Recuperation, discipline = Warding, type = Ward, level =Expert, range =Wandtip, incant = volo alterum, duration = 1 hour,noHigh = 1, noResist =1, noBlock = 1, effect =You create an aura of jealousy and desire for power around the target. At any point in the next hour when a beneficial spell is cast within 5m of the warded being\comma{} on something other than the target of this ward\comma{} they may activate this field and redirect the magic onto themselves. 

The original target of the spell gains no benefit\comma{} and the effect is applied to the warded being instead\comma{} as if they had been targeted.
}


\spell{
	name = Mortar Pulse, school = Maledictions, discipline = Hex, type = Instant, level =Beginner, range =Close, incant = sivango, noDur = 1, higher = \additional{1d6}{Concussive},resist = Reflex, noBlock = 1, effect =Raising your wand into the air\comma{} you send a small blue blob arcing upwards until it smashes down onto a targeted area within range\comma{} releasing a pulse out into a circle 2 metres in radius. 

All beings take 1d6 +1 concussive damage\comma{} halved on a successful Resist.
}


\spell{
	name = Mungo\apos{}s Metamorphasis, school = Recuperation, discipline = Healing, type = Focus, level =Master, range =Wandtip, incant = regus, duration = 5 minutes,noHigh = 1, noResist =1, noBlock = 1, effect =This spells vastly increases the natural healing rate of a being \minus{} they heal at a rate of 40HP per minute (2HP per combat cycle)\comma{} broken bones mend themselves and even severed limbs regrow over the course of the spell. 

By the end of the spell\comma{} the target has been restored 200HP and is in perfect health.
}


\spell{
	name = Necrosis, school = Dark Arts, discipline = Necromancy, type = Instant, level =Novice, range =Sight, incant = carnes mortis, noDur = 1, higher = \additional{2d8}{necrotic},noResist =1, negation = Blockable,effect =A bolt of sickly green energy crackles into your opponent\comma{} seeking to destroy their life force and spreading evil and decay. Do 3d8 necrotic damage.
}
...
\spell{
	name = Object Swarm, school = Maledictions, discipline = Hex, type = Focus, level =Adept, range =Close, incant = oppugno, noDur = 1, higher = An additional 3 objects are enchanted for every additional spell level dedicated to this spell.,noResist =1, negation = Blockable  and Dodgeable,effect =Causes 5 nearby objects to violently hurl themselves at the target. 

Each object does 1d6 bludgeoning damage\comma{} with the caster performing an accuracy check for each of them.
}
...
\spell{
	name = Otherworldly Sight, school = Divination, discipline = Temporal, type = Instant, level =Novice, range =Self, incant = vagus, duration = 10 minutes,noHigh = 1, noResist =1, noBlock = 1, effect =You attune your sight such that you can detect the presence of beings originating from other planes of existence\comma{} or which have recently traversed the voids between worlds. 

Any being which is native to any other plane than the one on which you stand\comma{} such as a summoned or conjured creature\comma{} or simply a being with the ability to travel between dimensions has a bright aura around them in your vision. A being which is native to your current plane\comma{} but which has travelled through worlds at some point within the past year and a day also shows up with a much fainter aura.
}


\spell{
	name = Overpowering Humiliation, school = Illusion, discipline = Psionics, type = Ward, level =Beginner, range =Close, incant = pudor, duration = 1 minute,higher = \additional{1d6}{psychic},resist = Conviction, noBlock = 1, effect =On a failed Resist\comma{} you latch a ward onto the target creature which laughs and mocks into the ear of the target whenever they suffer failure. 

Whenever the creature fails a check of any kind\comma{} they take 1d6 + 1 psychic damage.
}


\spell{
	name = Pain Beyond Measure, school = Dark Arts, discipline = Necromancy, type = Focus, level =Adept, range =Close, incant = Crucio, noDur = 1, higher = For every additional spell\minus{}level dedicated to casting this spell\comma{} it inflicts an extra 2d8 psychic damage. .,resist = Conviction/Willpower, noBlock = 1, effect =Causes immense pain to the target\comma{} rendering them {\it Incapacitated} whilst the spell is cast and dealing 4d8 psychic damage to the target. At the beginning of each turn\comma{} the target may attempt to Resist the spell. A successful Resist negates the {\it Incapacitated} status and halves the damage taken that turn cycle. Two consecutive Resists break the spell. 
...
\spell{
	name = Plague of Insects, school = Dark Arts, discipline = Necromancy, type = Instant, level =Adept, range =Sight, incant = prorepere, duration = 2 minutes,higher = \additional{1d6}{each of poison and piercing},resist = Intimidation, noBlock = 1, effect =Summon a swarm of insects from the ground in an radius 10 metres around a targeted point. All beings besides the caster within the region take 2d6 poison damage and 2d6 piercing damage every turn that they spend time inside the region\comma{} negated on a successful Resist.
}
...
The caster may also take a minor action to summon bolts of lightning to strike 2d4 targets in sight\comma{} dealing 8d8 electric damage (halved on a resist)\comma{} or to spawn a {\it Tornado} (see relevant spell) which stays fixed at a specified location for 5 turns.
}


\spell{
	name = Prime Spheroid, school = Charms, discipline = Elemental, type = Focus, level =Expert, range =Close, incant = panigus, noDur = 1, noHigh = 1, resist = Reflex, noBlock = 1, effect =A stream of water\comma{} a jet of flame or a trail of earth glides through the air and pools to form a giant floating sphere up to 2m in radius\comma{} hovering above the ground. The sphere twist\comma{} remolds and reforms itself violently in a display of chaotic\comma{} elemental power. 
...
\begin{spellitemize}
\boldItem{Air}{Take 2d6 slashing damage per turn\comma{} and take disadvantage on all Resist checks}
\boldItem{Earth}{Take 3d10 bludgeoning damage per turn}
\boldItem{Electricity}{Take 2d10 electric damage and take the {\it Paralyzed} status effect}
\boldItem{Fire}{Take 3d8 fire damage per turn\comma{} and take the {\it Burned: Mild} status effect}
\boldItem{Ice}{Take 4d6 cold damage per turn\comma{} and take the {\it Frostbitten: Mild} status effect}
\boldItem{Light}{Take 3d10 celestial damage and take the {\it Blinded} status effect}
...
\spell{
	name = Produce Water, school = Charms, discipline = Elemental, type = Focus, level =Beginner, range =Wandtip, incant = aguamente, noDur = 1, higher = Casting this spell at a higher level summons a more powerful torrent of water\comma{} allowing you to put out larger fires and produce larger puddles and ponds.,noResist =1, negation = Blockable  and Dodgeable,effect =A jet of water is emitted from the tip of your wand\comma{} in a fountain approximately 30cm in length\comma{} useful for extinguishing small fires\comma{} or cleaning surfaces.

Note\comma{} however\comma{} that Gamp\apos{}s Laws of Elemental Transfiguration states that all conjured water evaporates upon drinking: it cannot be used for sustenance\comma{} though it seems that it can be used to water plants.
}
...
This spell extends out in a cone up to 3 metres from your wand. All creatures caught in this region take 8d6 psychic damage\comma{} halved on a successful resist.
}


\spell{
	name = Psychic Crush, school = Illusion, discipline = Psionics, type = Instant, level =Novice, range =Close, incant = myalo synthis, noDur = 1, higher = \additional{2d10}{psychic},resist = Logic, noBlock = 1, effect =A great psychic force smashing to your opponent\comma{} overloading their psyche and brinigng them to the edge of insanity. 

The target takes 2d10 psychic damage\comma{} halved on a successful resist.
}
...
\spell{
	name = Psychic Scream, school = Illusion, discipline = Psionics, type = Instant, level =Beginner, range =Close, incant = magnus surgerus, noDur = 1, higher = The wail gains an additional 1d6 psychic damage for every additional spell level dedicated to the casting.,resist = Willpower, noBlock = 1, effect =All targets in a 3m spherical radius of the caster take 1d6+2 points of psychic damage\comma{} and awaken if they are sleeping\comma{} negated on a successful Resist.
}


\spell{
	name = Psychosis, school = Illusion, discipline = Psionics, type = Instant, level =Expert, range =Sight, incant = demensus, noDur = 1, higher = \additional{3d10}{psychic},noResist =1, negation = Dodgeable,effect =The target is wracked with uncontrollable pain as their very perception of reality is messed with. 

Target takes 5d10 psychic damage.
}


\spell{
	name = Psychosomatism, school = Illusion, discipline = Psionics, type = Focus, level =Master, range =Sight, incant = animo materia, noDur = 1, noHigh = 1, resist = Conviction, noBlock = 1, effect =You exploit the link between the mind and the body to cause harm to the body by making them truly believe they are suffering harm. 
...
\spell{
	name = Puppets of Flesh, school = Dark Arts, discipline = Necromancy, type = Ritual (30 seconds), level =Beginner, range =Wandtip, incant = inferi exorior, noDur = 1, noHigh = 1, noResist =1, noBlock = 1, effect =Conduct a profane rite which breathes unlife into dead bodies\comma{} and turns them into ghastly puppets\comma{} performing your every whim.
...
\dualEntry{Beginner}{Skeletons}
\dualEntry{Novice}{Inferi}
\dualEntry{Adept}{Mummy}
\dualEntry{Expert}{Wight}
\dualEntry{Master}{Revenant} 
\end{rndtable}
...
\spell{
	name = Purify, school = Recuperation, discipline = Healing, type = Instant, level =Trivial, range =Wandtip, incant = largitus, noDur = 1, noHigh = 1, noResist =1, noBlock = 1, effect =You wave your wand over some food or water and purge it of rot\comma{} decay and disease. 

The water and food are cleansed of any bacteria or mould that may have built up on them\comma{} making them safe to consume. However\comma{} this spell does not affect the presence of poisons and venoms which have been placed there by unnatural means.
}


\spell{
	name = Radiant Burst, school = Recuperation, discipline = Healing, type = Instant, level =Novice, range =Sight, incant = sol maxima, noDur = 1, higher = The spell deals an additional 1d8 celestial damage\comma{} and heals an additional 1d4 points \forEvery{}.,resist = Power, noBlock = 1, effect =A bolt of magic is released from the end of your wand\comma{} rocketing towards a targeted region. The bolt explodes on contact with any solid or astral objects in its path\comma{} releasing a searing white light that does 2 + 2d8 Celestial Damage in a 5m radius\comma{} halved on a successful Resist. Beings which are immune to Celestial damage are healed by 2d4 points instead.
}
...
\spell{
	name = Recurring Light, school = Maledictions, discipline = Hex, type = Focus, level =Adept, range =Close, incant = catena, noDur = 1, higher = \additional{1d8}{force},noResist =1, negation = Blockable,effect =A beam of blinding energy shoots from your wand in a line up to 8m long\comma{} striking one target before seeking the next. Each target takes 3d8 force damage as the beam refracts through them and onto the next target. Each time a new target is struck\comma{} perform a new accuracy check. 

The beam stops only if there are no new\comma{} detectable targets within 8m\comma{} or if one of the targeted beings successfully blocks it. If multiple beings are a valid next target\comma{} the next one is chosen at random.
}
...
\spell{
	name = Relinquish Grip, school = Recuperation, discipline = Healing, type = Instant, level =Beginner, range =Close, incant = relashio, noDur = 1, noHigh = 1, resist = Strength, noBlock = 1, effect =On a failed Resist a target sapient being is forced to release their grip on another being\comma{} ending a grapple or similar effects.
}


\spell{
	name = Relive Memory, school = Illusion, discipline = Psionics, type = Instant, level =Expert, range =Close, incant = legilimens, noDur = 1, noHigh = 1, resist = Willpower, noBlock = 1, effect =Probe deep into the mind of the target\comma{} and uncover even deeply buried memories. If the target fails to Resist\comma{} the caster plunges both themselves and the target into a memory of the caster\apos{}s choice\comma{} which both parties then experience in detail\comma{} as if they were reliving the moment as observers. 

Whilst in the memory\comma{} the observers can interact with each other verbally\comma{} but phase through all objects in the memory\comma{} and each other\comma{} as if they were ghosts\comma{} and people in the memory are unaware of their presence. 

The actual reliving of the memory occurs in an instant\comma{} and is over almost instantaneously\comma{} though from those experiencing it may experience several hours pass.
}
...
This spell cannot heal a target to more than 50\% their maximum health. If the target has a {\it Major Injury}\comma{} this is reduced to 25\%.
}
...
\spell{
	name = Restore, school = Recuperation, discipline = Healing, type = Instant, level =Novice, range =Wandtip, incant = episkey, noDur = 1, higher = Heal an additional 1d8 HP \forEvery.,noResist =1, noBlock = 1, effect =Heal the target for 3d10 HP.
...
\spell{
	name = Runic Shield, school = Recuperation, discipline = Warding, type = Ward, level =Novice, range =Wandtip, incant = scutum, duration = 1 hour,noHigh = 1, noResist =1, noBlock = 1, effect =You draw an arcane rune in the air with your wand\comma{} and press it into a targeted being. 

The target is Resistant to that a chosen damage type for the duration of the spell. Each individual may only have one Runic Shield active at a time.
}
...
\spell{
	name = Seeker\apos{}s Sight, school = Divination, discipline = Temporal, type = Instant, level =Beginner, range =Self, noIncant = 1, noDur = 1, noHigh = 1, noResist =1, noBlock = 1, effect =Pointing your finger at a target\comma{} you can see where the target is going to move\comma{} allowing you to hone in on them. 

Next turn\comma{} you take advantage on accuracy checks against the target.
}
...
\spell{
	name = Shadowsight, school = Dark Arts, discipline = Occultism, type = Focus, level =Beginner, range =Self, incant = ivertus, noDur = 1, noHigh = 1, noResist =1, noBlock = 1, effect =Invert your vision \minus{}\minus{} pure darkness is considered bright light\comma{} and bright light is considered pure darkness for as long as the spell is maintained.
}
...
The next time that an attack or environmental effect would reduce the target to 0HP\comma{} they are instead reduced to 1HP\comma{} and the spell ends.
}
...
\spell{
	name = Shockwave, school = Maledictions, discipline = Hex, type = Instant, level =Novice, range =Self, incant = inpusla, noDur = 1, higher = \additional{1d6}{Concussive},resist = Reflex, noBlock = 1, effect =A shockwave emanates from the caster in every direction\comma{} for a radius of 3m\comma{} doing 2d6 concussive damage (halved on a successful Resist) to all beings caught in the radius. Beings which fail to resist must roll a 1d4. On a 1\comma{} they are knocked prone.
}
...
\spell{
	name = Silence, school = Illusion, discipline = Psionics, type = Instant, level =Adept, range =Sight, incant = silencio, duration = 15 seconds,noHigh = 1, resist = Power, noBlock = 1, effect =If the target fails to Resist\comma{} they may not speak or otherwise vocalise for the duration of the spell.
}
...
Affected beings get a + 5 bonus to Stealth checks.
}
...
\spell{
	name = Sorcerous Tornado, school = Charms, discipline = Elemental, type = Focus, level =Master, range =Close, incant = stilipare, noDur = 1, noHigh = 1, resist = Strength, noBlock = 1, effect =A swirling\comma{} twisting column of cloud forms in the atmosphere above a targeted region within range. After 1 turn cycle of concentration the tornado slams into the ground as a cylinder 5m in radius and 50m tall. You may spend a major action moving the tornado up to 10m per turn cycle. 

Any being which spends any part of a turn cycle in this region takes 5d8 bludgeoning damage and must succeed on a Resist check\comma{} or be caught in the vortex\comma{} taking the {\it Trapped} status effect.
...
\spell{
	name = Soulsnare, school = Dark Arts, discipline = Necromancy, type = Instant, level =Ascendant, range =Self, incant = nerco decipula, noDur = 1, noHigh = 1, noResist =1, noBlock = 1, effect =Capture the soul of an enemy killed in the past 30 seconds. 
...
\spell{
	name = Spiral Inversion, school = Maledictions, discipline = Hex, type = Instant, level =Adept, range =Close, incant = anstroff maxima, noDur = 1, higher = \additional{2d6}{Force},resist = Strength, noBlock = 1, effect =A twisting\comma{} crushing force lashes out at your target\comma{} seeking to wrap them into a horrifying\comma{} spiralling knot of flesh. 

The target takes 5d6 bludgeoning damage\comma{} halved on a successful Resist.
}
...
\spell{
	name = Stream of Acid, school = Maledictions, discipline = Hex, type = Focus, level =Adept, range =Close, incant = saeclifors, noDur = 1, higher = \additional{2d4}{Acid},noResist =1, negation = Dodgeable,effect =You conjure a pencil\minus{}thin stream of corrosive green acid in a line from the tip of your wand up to a distance of 3m. Whilst maintaining concentration you may move and rotate yourself to change which beings are caught in the line\comma{} but damage is only dealt to targets who have the beam focussed on them for at least a major action. 

A being which falls into this region must succeed in dodging\comma{} or the acid dissolves armour\comma{} clothes and skin alike\comma{} doing 6d4 acid damage.
}
...
\spell{
	name = Sundering, school = Maledictions, discipline = Hex, type = Instant, level =Expert, range =Sight, incant = expulso, noDur = 1, higher = \additional{2d12}{Force},noResist =1, negation = Dodgeable,effect =Launches a magical bolt at the target which\comma{} if it makes contact\comma{} causes the object to violently tear itself apart\comma{} doing 4d12+4 force damage.
}


\spell{
	name = Suppress Intelligence, school = Illusion, discipline = Psionics, type = Instant, level =Adept, range =Wandtip, incant = romanes, duration = 2 minutes,higher = The Intelligence drain increases by 2 points \forEvery{}.,resist = Logic, noBlock = 1, effect =By touching your wand\minus{}tip to the head of the target\comma{} reduce their Intelligence attribute by 5 points (min 0) for the duration of the spell. This effect is negated on a successful Resist.
}


\spell{
	name = Suspended Animation, school = Recuperation, discipline = Healing, type = Ritual (30 minutes), level =Adept, range =Wandtip, incant = fautis, duration = 3 hours,noHigh = 1, noResist =1, noBlock = 1, effect =When cast upon a willing living being\comma{} they are placed into a state of suspended animation which perfectly replicates the outward appearance of death. All magical effects\comma{} poisons\comma{} curses and other time\minus{}dependent effects currently in place on the target are paused until the spell wears off. 
...
\spell{
	name = Temporal Shear, school = Divination, discipline = Temporal, type = Instant, level =Expert, range =Close, incant = tondendas, noDur = 1, noHigh = 1, resist = Power, noBlock = 1, effect =Target a sapient being and do a deliberately poor job at launching them through time\comma{} as with the {\it Tumble Through Time} spell. 

The resulting temporal fracturing they experience across their body causes immense physical damage\comma{} dealing 6d12 force damage on a failed Resist.
}
...
\spell{
	name = Threshold Ward, school = Recuperation, discipline = Warding, type = Ward, level =Novice, range =Sight, incant = desino, duration = 1 year,higher = Double the maximum size of the ward\comma{} and its effective\minus{}HP\comma{} \forEvery{}.,noResist =1, noBlock = 1, effect =You create a glowing\comma{} semi\minus{}opaque force\minus{}field over a door\comma{} window\comma{} hatch or other such opening. This field prevents any physical objects or beings from passing over the edge of the ward\comma{} though you can still see and hear through it. 

The maximum size of the ward is a circle 2m in radius\comma{} but within this size you can shape it as you wish as long as all edges of the field are connected to a physical object. The ward is immune to all physical damage\comma{} but can only survive 10 points of spell damage before disintegrating.
}
...
\spell{
	name = Ticklish Blast, school = Maledictions, discipline = Hex, type = Instant, level =Beginner, range =Close, incant = rictumsempra, duration = 1 minute,higher = \additional{1d8}{Concussive},noResist =1, negation = Blockable  and Dodgeable,effect =When this spell strikes the target\comma{} they take 1d8 concussive damage\comma{} and in addition they begin chuckling uncontrollably for the duration of the spell\comma{} reducing their ability to be taken seriously. 

The target takes disadvantage on all charisma checks (and associated spellcasting checks) for the duration.
}
...
\spell{
	name = Timespike, school = Divination, discipline = Temporal, type = Focus, level =Novice, range =Close, incant = vallianus entropus, noDur = 1, noHigh = 1, resist = Power, noBlock = 1, effect =A rope of fine silver light erupts from your wand\comma{} and wraps around a targeted being. On a failed Resist\comma{} your mind races back through their timestream\comma{} learning brief flashes of information about the key milestones in the target\apos{}s life as you go. 

Every turn the spell is active\comma{} you may learn some information about the target\comma{} such as:
\begin{spellitemize}
\boldItem{Childhood}{Learn where they were born\comma{} grew up and basic information about their parents}
\boldItem{Epiphanies}{Moments which shaped their personality\comma{} for better or for worse}
\boldItem{Milestones}{Signigicant\comma{} life\minus{}changing events in their recent history}
\boldItem{Motivations}{Events which caused them to undertake their current course of action} 
\end{spellitemize}

Each piece of information should be phrased as a single question\comma{} though the nature of traversing the timestream is more of an art than a science\comma{} and is often refracted through the target\apos{}s own understanding of events: attempting to learn why a foe attempted to kill you may simply result in a vision of a large suitcase full of money\comma{} rather than the name of the person who gave the order.

For every subsequent cycle that motivation is maintained\comma{} you may attempt to learn more information\comma{} but the target gets an additional chance to Resist at the beginning of every round.
}


\spell{
	name = Total Disruption Field, school = Recuperation, discipline = Warding, type = Ward, level =Ascendant, range =Wandtip, incant = kafsis, duration = 5 minutes,noHigh = 1, resist = Attention, noBlock = 1, effect =You place an incredibly powerful ward at a point in space\comma{} erecting a force field with a maximum radius equal to your twice your power attribute (in metres). 

Any being which attempts to pass over the threshold must succeed on a Resist\comma{} or take a step inside the field. Taking a step inside the field deals 8d12 force damage\comma{} and if the target then fails a subsequent DV 10 Reflex Resist\comma{} they continue entirely over the threshold and are annihilated entirely. 
...
\spell{
	name = Trojan Undermining, school = Maledictions, discipline = Curse, type = Instant, level =Adept, range =Close, incant = mora, duration = 5 minutes,noHigh = 1, resist = Logic, noBlock = 1, effect =The target feels a warm\comma{} healing aura descend upon them – as if they had been targeted by a powerful healing spell. If the target succeeds on a Resist check\comma{} they may choose to refuse this gift. Targets which have no allies\comma{} or whose allies cannot cast magic have advantage on this Resist check. 

If they accept the gift\comma{} the target is restored by 2d6 HP\comma{} however for the duration of the spell they also become more vulnerable to a Damage type chosen by the caster: the being loses a Resistance to that damage type\comma{} and if it has no Resistance\comma{} it is considered Susceptible. This spell has no additional effect if it is Immune to the chosen damage type.
}
...
Any being which spends any part of its turn in the wave takes 8d10 + 5 damage (halved on a successful resist) and have their speed set to zero until the end of the next round.
}


\spell{
	name = Tumble Through Time, school = Divination, discipline = Temporal, type = Focus, level =Adept, range =Close, incant = qortina, noDur = 1, higher = The speed at which objects tumble through time doubles \forEvery{}.,noResist =1, noBlock = 1, effect =Target a non\minus{}sapient being or object within range\comma{} and send it spinning forward or backward in time by 1 day per second. Plants will grow and age\comma{} food will rot and wilt (or\comma{} rotten food may become fresh again)\comma{} and weapons will rust and grow dull.
}
...
\spell{
	name = Vicious Slash, school = Dark Arts, discipline = Necromancy, type = Instant, level =Beginner, range =Close, incant = sectumsempra, noDur = 1, higher = Gain an additional 1d8 slashing damage for each additional spell level dedicated to casting this spell.,noResist =1, negation = Blockable,effect =Bolts of energy strike out at the target\comma{} goughing at them and leaving deep\comma{} cursed wounds\comma{} for 1d8+4 points of slashing damage. This damage is halved on a successful Block.
}


\spell{
	name = Violent Phantasms, school = Illusion, discipline = Psionics, type = Instant, level =Novice, range =Close, incant = umbra impetia, duration = 20 seconds,higher = \additional{2d4}{Psychic},resist = Conviction, negation = Blockable,effect =Purple ethereal energy seeks out the target and infiltrates their mind. The target performs a Resist check at the end of every turn\comma{} on a success the spell is broken prematurely.

Whilst it is active\comma{} the spell causes the target to see enemies attacking them\comma{} with the form of the enemies chosen by the caster. The subject acts as if these targets are real\comma{} and will make attacks and try to avoid them as if they were really there. The `attacks’ from the imaginary opponents deal 3d4 psychic damage every cycle.
}


\spell{
	name = Voidsphere, school = Dark Arts, discipline = Occultism, type = Focus, level =Adept, range =Sight, incant = inanis, duration = 1 minute,higher = \additional{1d8}{cold},resist = Reflex, noBlock = 1, effect =Summon a true Void anywhere within 15m of your current position\comma{} a gap in the fabric of reality in the form of an inky black orb\comma{} 1m in radius. 
...
The target will react as if what they see is real (for them\comma{} it appears to be)\comma{} and will take actions accordingly. This illusion can remove no HP or FP\comma{} but the dreamer will believe that they have been damaged\comma{} and so will seek to avoid or negate any enemies as they would do in real life. 
...
\spell{
	name = Will\minus{}O\apos{}\minus{}the\minus{}Wisp, school = Dark Arts, discipline = Occultism, type = Instant, level =Novice, range =Close, incant = desuno, noDur = 1, higher = \additional{1d12}{fire},resist = Willpower, negation = Blockable,effect =A small burst of rainbow light dances from the end of your wand\comma{} and streaks towards your opponent\comma{} dealing 2d12 fire damage when it makes contact.
...
\spell{
	name = Witch Hunter\apos{}s Bane, school = Maledictions, discipline = Hex, type = Instant, level =Adept, range =Close, incant = iboq plustra, noDur = 1, higher = \additional{1d10}{slashing},noResist =1, negation = Blockable  and Dodgeable,effect =A searing white light solidifies into a maelstrom of vicious barbs\comma{} striking towards the target and dealing 3d10+2 slashing damage. 
...
\spell{
	name = Witchdoctor\apos{}s Touch, school = Recuperation, discipline = Healing, type = Instant, level =Novice, range =Close, noIncant = 1, noDur = 1, higher = You may remove one additional status effect from a target \forEvery{},noResist =1, noBlock = 1, effect =Remove one minor status effect afflicting the target: temporary {\it Blindness} and {\it Deafness}\comma{} minor {\it Burns}\comma{} {\it Frostbite} and {\it Poison}\comma{} as well as Paralysis.
}


\spell{
	name = Wither, school = Maledictions, discipline = Curse, type = Instant, level =Master, range =Close, incant = unis, duration = 1 minute,higher = The \attPhys{} penalty is increased by 2 \forEvery{}.,resist = Vitality, noBlock = 1, effect =Necrotic energy seeps up from the ground\comma{} into the target\comma{} causing them to undergo a severe physical degradation\comma{} reducing their \attPhys{} score by 2d8 points for the duration of the spell. 
...
\spell{
	name = Yawning Fissue, school = Charms, discipline = Elemental, type = Instant, level =Master, range =Close, incant = lohe, noDur = 1, higher = When cast as an Ascendant\minus{}level spell\comma{} the fissure deals an additional 2d8 bludgeoning damage.,resist = Acrobatics, noBlock = 1, effect =Target a line of natural ground (earth\comma{} mud\comma{} natural stone) up to 5m long. The earth rips asunder along this line\comma{} forming a fissure 1m wide and 10m deep. Any being caught in this region must pass a Resist check\comma{} or fall inside.

The fissure slams shut at the end of the turn cycle\comma{} trapping those inside underground and dealing 6d8+10 bludgeoning damage\comma{} and leaving them starved of air until they succeed in a DV 15 Strength check to dig their way out.
}


\spell{
	name = Zone of Silence, school = Recuperation, discipline = Warding, type = Ward, level =Adept, range =Wandtip, incant = umbra silentium, duration = 1 hour,noHigh = 1, noResist =1, noBlock = 1, effect =Ward an area up to 6 metres in radius with a powerful enchantment which prevents sound from travelling. No sound can penetrate or travel within this zone whilst the ward remians active. 

All non\minus{}silent spellcasting attempts fail\comma{} as do all hearing\minus{}related checks: beings within the zone take disadvantage on Observation checks.
}
