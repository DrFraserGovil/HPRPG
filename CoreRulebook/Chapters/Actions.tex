...
Therefore it is calculated from a score of 10, plus the usual bonuses. If a being has advantage or disadvantage, 
...
\proficiency{Observation}{A Perception (Observation) check occurs will be called for whenever you survey your surroundings, either with sight, sound or smell. }
