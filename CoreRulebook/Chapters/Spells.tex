...
\newcommand{\spell}[1]
{
	\setkeys{spell}{name=None,incant = -, school = None, type = None, level = 0, fp = 0, attribute = None, proficiency = None, dv = 0, effect = None,noIncant = 0,noProf=0,noDur=0,duration=None}
	\setkeys{spell}{#1}
	\vbox{
