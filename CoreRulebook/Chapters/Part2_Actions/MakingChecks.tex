\breaklesschapter{Performing Checks}\label{C:Checks}
...
\subsubsection{Catastrophes}\index{Catastrophic Failure|see{Checks!Catasrophes}} \index{Checks!Catastrophes}\label{S:Catastrophe}
