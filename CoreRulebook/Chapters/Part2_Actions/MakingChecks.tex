...
A miracular success occurs whenever you roll a \key{12}. A miracular success means that, even if the action fails, it does not do so catastrophically. 
...
\section{Extended Actions \& Projects}\label{S:Extended}
