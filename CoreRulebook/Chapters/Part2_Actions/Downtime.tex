...
\\
	Unskilled	&	Manual labour, farmwork &	\galleon{0.5}
	\\
	Moderate	&	Shopwork, guard	&	\galleon{1}
	\\
	Skilled	&	Teacher, performer, nurse	&	\galleon{3}
	\\
	Highly skilled	&	Artificier, surgeon	&	\galleon{5}
	\end{rndtable}
\end{center}
