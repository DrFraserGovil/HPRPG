...
When performing a \imp{ranged attack roll} whilst a non-incapacitated foe is within melee range\imp{Note that this is {\it their} melee range, not yours} of you (this foe could be the target of the attack, or simply a different enemy), you take a 2d penalty to the attack. 
