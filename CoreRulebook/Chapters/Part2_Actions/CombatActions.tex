...
The rules for performing attacks are elaborated on page \pageref{S:Attacks}.
	...
	\subsubsection{Negating} \index{Combat!Major Actions!Negating} \index{Blocking|see{Combat, Negation}} \index{Dodging|see{Combat, Negation}} \index{Enduring|see{Combat, Negation}}
