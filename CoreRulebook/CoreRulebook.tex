...
\newcommand{\dndlineFade}[1]{%
  \noindent
  \begin{tikzpicture}[]
    \fill [#1, shading=axis, shading angle = 90] (0, 0)--({\textwidth*0.5}, 0)--({\textwidth*0.5}, 0.01)--(0, 0.01);
  \end{tikzpicture}%
  \par%
}
...
\titleformat{\section}{\vspace{-3ex}\normalfont\huge\color{titlered}\it\centering}{}{0em}{}[{\vspace{-1.4ex}\dndlineFade{rulered}}]
\titleformat{name=\subsection,numberless}{\LARGE \bf}{}{0pt}{}[{\vspace{-1.7ex}\dndlineFade{black}}]
