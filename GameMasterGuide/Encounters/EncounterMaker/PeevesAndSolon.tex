...
\ability{Elemental Magic}{The solon may use its \imp{Spellcasting} ability to cast spells. It knows the \imp{Illuminate}\comma{} \imp{Sense} and \imp{Move} spells.}, hasLanguages = 1, languages = \speaks{Celestial}, hasImage = 1, image = solon, 
