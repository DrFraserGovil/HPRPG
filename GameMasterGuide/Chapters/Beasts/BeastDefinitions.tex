...
{
\parbox[t]{9.5cm}{\textbf{\textit{#1}}: ({\it melee attack, range: #6m #2 dice, DV \fpeval{7+#3}}) \\ Effect: \imp{#4}, with Power #5}
}
\newcommand\melee[5]
{
...
{
	\parbox[t]{9.5cm}{\textbf{\textit{#1}}: ({\it melee attack, #2 dice, DV \fpeval{7+#3}}) \\ Effect: \imp{#4}, with Power #5 \\ {\it #6}}
}
\newcommand\extendedmeleeConsequence[7]
{
	\parbox[t]{9.5cm}{\textbf{\textit{#1}}: ({\it melee attack, range #7m,  #2 dice, DV \fpeval{7+#3}}) \\ Effect: \imp{#4}, with Power #5 \\ {\it #6}}
}
\newcommand\ranged[6]
{
...
{
\parbox[t]{10cm}{\textbf{\textit{#1}}: ({\it ranged attack: #2m, #3 dice, DV \fpeval{7+#4}}) \\ Effect: \imp{#5}, with Power #6. \\ {\it #7}}
}
