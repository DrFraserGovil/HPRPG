...
\newcommand\ranged[6]
{
\parbox[t]{10cm}{\textbf{\textit{#1}}: ({\it ranged attack, #3 dice, DV \fpeval{7+#4}, range #2m}) \\ Effect: \imp{#5}, with Power #6}
}
...
\newcommand\sideBySide
{
	...
	\includegraphics[width = 0.9 \textwidth, keepaspectratio=true]{../Images/\image}
	\end{minipage}
