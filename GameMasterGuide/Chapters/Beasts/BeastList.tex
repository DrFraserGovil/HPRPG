...
\speciesBeast{name = Armoured Guardian, species = Animated Object, mind = Non\minus{}sapient, category = Construct, rating = III, abilities = \ability{Mindless}{A \name{} has no true mind\comma{} being animated purely by magical energies. It is therefore resistant to all mental effects\comma{} including most spells from the \imp{Illusion} school – though it can be deceived by \imp{Mirages}. }, article = A, movement = \speeds{\speedrating{Walking}{2}}, fit =5, prs =4, vit =4, cha =0, dec =0, ins =0, int =0, wil =1, pcp =1, hasDamage = 1, damage =\key{Immune} to \textit{Psychic damage\comma{} mental conditions} and \key{Resistant} to \textit{Cutting damage}, nUnharmed=3, nBruised=0, nHurt=0, nInjured=0, nWounded=1, nMangled=0, block=5, dodge=4, defy=0, fortitude=1, imageStack=0, hasSkills = 1, skills = \skill{Strength}{3}
, hasAttacks = 1, attacks = \melee{Sword strike}{4}{\minus{}1}{Physical damage}{2 + Successes}, hasImage = 1, image = knight, description = A mundane suit of armour that has been brought to life through the use of the \imp{Animate} spell\comma{} a \name{} is a mindless automaton which strives to protect its master at whatever cost. 

Because of their relative ease of creation\comma{} and their total and utter devotion to their master\comma{} they are often used as defensive forces against invaders in castles and stately homes \minus{} \imp{Hogwarts} maintains hundreds of suits of armours for this very purpose\comma{} though they have only been activated a handful of times across history.}
...
\speciesBeast{name = Living Book, species = Construct, mind = Ineffable, category = Construct, rating = I, abilities = \ability{Brain Drain}{All creatures within 5m of a \name{} suffer a 1d penalty to all intelligence checks\comma{} but must succeed on a DV 8 \imp{Intelligence (Investigation)} check to understand that this is what is happening.}, article = A, movement = \speeds{\speedrating{Flying}{4}}, fit =1, prs =2, vit =0, cha =0, dec =0, ins =0, int =3, wil =1, pcp =1, hasDamage = 0, nUnharmed=1, nBruised=0, nHurt=1, nInjured=0, nWounded=0, nMangled=0, block=1, dodge=4, defy=2, fortitude=1, imageStack=0, hasSkills = 1, skills = \skill{Flight}{1}
, hasAttacks = 1, attacks = \melee{Slam}{2}{\minus{}2}{Bashing Damage}{1 + Successes}, hasLanguages = 1, languages = \understands{Human language}, description = A soul\minus{}imbued book}
...
{
\beast{name = Crows, species = Mundane Animal, mind = Non\minus{}sapient, category = Beast, rating = II, abilities = , article = A, movement = \speeds{\speedrating{Flying}{12}}, fit =2, prs =2, vit =0, cha =0, dec =0, ins =1, int =0, wil =0, pcp =2, hasDamage = 0, nUnharmed=1, nBruised=0, nHurt=1, nInjured=0, nWounded=1, nMangled=1, block=2, dodge=4, defy=0, fortitude=1, imageStack=0, hasSkills = 1, skills = \skill{Flight}{3}
, hasAttacks = 1, attacks = \melee{Peck}{4}{\minus{}1}{Stabbing Damage}{1 + Successes}, description = A normal flock of crows}
\beast{name = Wolf, species = Mundane Animal, mind = Non\minus{}sapient, category = Beast, rating = II, abilities = \ability{Pack Animal}{A \name{} gets one automatic success when within 1m of another \name{}. Every additional \name{} (up to a maximum of 3) grants +1d}, article = A, movement = \speeds{\speedrating{Walking}{8}}, fit =3, prs =1, vit =1, cha =0, dec =1, ins =1, int =0, wil =0, pcp =1, hasDamage = 0, nUnharmed=2, nBruised=1, nHurt=1, nInjured=1, nWounded=0, nMangled=0, block=1, dodge=3, defy=0, fortitude=1, imageStack=0, hasSkills = 1, skills = \skill{Speed}{5}
, hasAttacks = 1, attacks = \melee{Maul}{3}{\minus{}1}{Stabbing Damage}{2 + Successes}, description = A wolf}
\beast{name = Giant Snake, species = Mundane Animal, mind = Non\minus{}sapient, category = Beast, rating = II, abilities = , article = A, movement = \speeds{\speedrating{Walking}{5}}, fit =2, prs =2, vit =2, cha =0, dec =1, ins =1, int =0, wil =1, pcp =1, hasDamage = 1, damage =\key{Resistant} to \textit{Poison}, nUnharmed=2, nBruised=2, nHurt=1, nInjured=1, nWounded=0, nMangled=0, block=2, dodge=2, defy=1, fortitude=1, imageStack=0, hasSkills = 1, skills = \skill{Speed}{2}
, hasAttacks = 1, attacks = \melee{Bite}{3}{\minus{}1}{Stabbing Damage}{2 + Successes}

\area{Spray}{cone 3m from \name{}}{4}{\minus{}1}{Poison Damage}{1 + Successes}, description = A very large snake}
