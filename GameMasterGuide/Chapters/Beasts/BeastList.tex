...
\speciesBeast{name = Chimera, species = Chimera, mind = Non\minus{}sapient, category = Monstrosity, rating = VII, abilities = \ability{Eyes everywhere}{A \name{} has perfect 360$^\circ$ vision\comma{} and cannot be snuck up upon or surprised\comma{} except by magical invisibility.}, article = A, fit =4, prs =4, vit =5, cha =2, dec =2, ins =2, int =4, wil =6, pcp =7, hasDamage = 0, nUnharmed=6, nBruised=4, nHurt=3, nInjured=2, nWounded=2, nMangled=0, block=5, dodge=6, defy=5, fortitude=7, imageStack=1, hasAttacks = 1, attacks = \ability{Multiheaded}{As a single \imp{Major action}\comma{} each head may make an attack of their choosing\comma{} or attempt to negate an incoming attack.}
