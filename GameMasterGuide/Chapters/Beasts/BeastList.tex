...
\skill{Covert}{4}
\skill{Inhuman Senses}{2}, hasAttacks = 1, attacks = \meleeConsequence{Poison Fangs}{3}{0}{Piercing Damage}{1+Successes}{If the attack deals any damage\comma{} the victim takes the \imp{Poisoned} status (1 harm\comma{} requires 5 successes)}, hasLanguages = 1, languages = \understands{Spider Tongue}, hasImage = 1, image = babyAcro, description = A newborn \imp{acromantula} is tiny when compared to their full grown counterparts – though with a legspan of up to 40cm\comma{} they are still significantly larger than almost all non\minus{}magical spiders. 
...
\ability{Sticky Feet}{A \name{} may use their \imp{Climbing} ability to walk on any vertical surface.}, article = A, fit =2, prs =3, vit =2, cha =0, dec =1, ins =1, int =1, wil =2, pcp =4, hasDamage = 1, damage =\key{Immune} to \textit{Poison}, nUnharmed=1, nBruised=1, nHurt=1, nInjured=0, nWounded=0, nMangled=1, block=1, dodge=2, defy=1, fortitude=1, imageStack=0, hasSkills = 1, skills = \skill{Climb}{3} \skill{Covert}{4} \skill{Inhuman Senses}{3}, hasAttacks = 1, attacks = \melee{Bite}{5}{\minus{}2}{Stabbing damage}{1 + Successes}

\ability{Inject Poison}{{\it three / day} As an instant action\comma{} the \name{} injects a victim of its \imp{Bite} attack with venom. Victim takes the \imp{Poisoned} status effect (level 3 harm\comma{} requires 5 successes\comma{} DV 7) }
...
\beast{name = Spraying Mantis, species = Arachnid, mind = Non\minus{}sapient, category = Beast, rating = III, abilities = , article = A, fit =3, prs =5, vit =2, cha =0, dec =1, ins =2, int =2, wil =1, pcp =3, hasDamage = 1, damage =\key{Immune} to \textit{Acid\comma{} Poison}, nUnharmed=3, nBruised=0, nHurt=1, nInjured=1, nWounded=0, nMangled=1, block=3, dodge=2, defy=2, fortitude=3, imageStack=0, hasLanguages = 1, languages = \understands{Spider Tongue}, description = A gigantic\comma{} horrifying crossbreed between a spider\comma{} and a praying mantis resulted in a grotesque monstrosity. The being appears\comma{} outwardly\comma{} to be a giant metre\minus{}long insect walking on 4 legs\comma{} with an additional 4 arms turned into hinged and hooked arms which they use to catch their prey. 
