...
\newcommand\realm[3]
{
	...
	\begin{center}
		\includegraphics[width = 0.4\textwidth, keepaspectratio = true]{../Images/#2}
	\end{center}
...
\subrealm{Abyss}{The Realm of Terror}{abyss}
{
...
\subrealm{Hades}{The Realm of Death}{hades}
{
...
\subrealm{Elysium}{The Realm of Blessings}{elysium}
{
...
\subrealm{Scholomancia}{The Realm of Knowledge}{scholomancia}
{
...
\subrealm{Aeolus}{The Realm of Storms and Winds}{aeolus}
{
...
\subrealm{Eden}{The Realm of Nature, Life and Death}{eden}
{
