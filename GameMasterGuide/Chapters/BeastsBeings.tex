...
\beast{name = Giant Civilian, species = Giants, mind = Sapient, category = Gigantoid, summary = Gigantic Humanoid, speed = , habitat = , sizeName = , size = , needsLine = 0, imageHeight = 0.4, rating = IV, fit = 0 (-5),prs = 0 (-5),spr = 0 (-5),chr = 0 (-5),int = 0 (-5),pcp = 0 (-5),pow = 0 (-5),evl = 0 (-5),hp=NaN, block=NaN, dodge=NaN, abilityBlock=0, needsPage=0, imPosition = 0,description = }{0}


\beast{name = Giant Elder, species = Giants, mind = Sapient, category = Gigantoid, summary = Wise(ish) Civilian Leader, speed = , habitat = , sizeName = , size = , needsLine = 0, imageHeight = 0.4, rating = IV, fit = 0 (-5),prs = 0 (-5),spr = 0 (-5),chr = 0 (-5),int = 0 (-5),pcp = 0 (-5),pow = 0 (-5),evl = 0 (-5),hp=NaN, block=NaN, dodge=NaN, abilityBlock=0, needsPage=0, imPosition = 1,description = }{0}


\beast{name = Giant Warrior, species = Giants, mind = Sapient, category = Gigantoid, summary = Enormous Primal Warrior, speed = , habitat = , sizeName = , size = , needsLine = 0, imageHeight = 0.4, rating = IV, fit = 0 (-5),prs = 0 (-5),spr = 0 (-5),chr = 0 (-5),int = 0 (-5),pcp = 0 (-5),pow = 0 (-5),evl = 0 (-5),hp=NaN, block=NaN, dodge=NaN, abilityBlock=0, needsPage=0, imPosition = 0,description = }{0}


\beast{name = Gurg, species = Giants, mind = Sapient, category = Gigantoid, summary = Clan Leader, speed = , habitat = , sizeName = , size = , needsLine = 0, imageHeight = 0.4, rating = V, fit = 0 (-5),prs = 0 (-5),spr = 0 (-5),chr = 0 (-5),int = 0 (-5),pcp = 0 (-5),pow = 0 (-5),evl = 0 (-5),hp=NaN, block=NaN, dodge=NaN, abilityBlock=0, needsPage=0, imPosition = 1,description = }{0}
