...
\ability{Command Legions}{The Wielder\minus{}of\minus{}Night may use their major action to command any other Abyssal Spawn in hearing\comma{} giving them check\minus{}advantage on their next check.}, hasSkills = 1, skills = Willpower (+10)\comma{} Logic (+13)\comma{} Investigation (+12), hasImage = 1, image = spawn, hasLanguages = 1, language = Voidic, imPosition = 0,description = The general of the Abyssal Armies\comma{} commanding untold legions of lesser creatures. They wield an enormous scythe\comma{} which crackles with frost.}{0}
