...
\spell{name = Magnetising Pulse, school = Maledictions, discipline = Hex, type = Instant, level =Beginner, range =Close, incant = adtraho, duration = 5 seconds,higher = \additional{1d8}{force},resist = Acrobatics or Speed, noBlock = 1, effect =A pulse of energy streaks out towards the target faster than a normal `dodge\apos{} could avoid.

On a failed Resist\comma{} the target takes 1d8 force damage\comma{} and all attacks made on them next turn are at advantage.}
...
\spell{name = Witch Hunter\apos{}s Bane, school = Maledictions, discipline = Hex, type = Instant, level =Expert, range =Close, incant = iboq, noDur = 1, noHigh = 1, noResist =1, negation = Blockable,effect =A searing white light solidifies into a maelstrom of vicious barbs\comma{} striking towards the target and dealing 4d10 slashing damage. 
