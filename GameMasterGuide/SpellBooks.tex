...
\spell{name = Entrance Other, school = Illusion, discipline = Bewitchment, type = Instant, level =Adept, range =Wandtip, incant = meamicus, duration = 1 minute,noHigh = 1, resist = Conviction, noBlock = 1, effect =If the target fails to Resist\comma{} they become hopelessly besotted with the caster and become {\it Charmed} for the duration of the spell.}
...
\spell{name = Fury, school = Illusion, discipline = Psionics, type = Instant, level =Adept, range =Sight, incant = irafors, duration = 30 seconds,noHigh = 1, resist = Empathy, noBlock = 1, effect =Target performs a Resist check\comma{} if they fail\comma{} target flies into a mindless rage and begins attacking all those around them.}
