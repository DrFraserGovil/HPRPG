...
\spell{name = Counterspell, school = Charms, discipline = Kinesis, type = Ritual (30 seconds), level =Novice, range =Wandtip, incant = finite incantatem, noDur = 1, higher = For every additional spell\minus{}level dedicated to casting this spell\comma{} the maximum spell level which can be ended increases by one. 

In addition\comma{} when contesting against an active spellcaster\comma{} gain a one\minus{}point bonus to your spellcasting check per additional level.,noResist =1, noBlock = 1, effect =End the ongoing effects of any active Beginner\minus{}level spell on the targeted object or being. 

This spell does not work on shields or wards\comma{} or spells from the curses discipline.

If a being is still actively casting a Focus spell on your chosen target\comma{} perform a spellcasting check against the Arcane Subjugation value of the spellcaster\comma{} plus a 1\minus{}point bonus per spell level of the spell they are casting. If your check succeeds\comma{} the caster loses focus and ends their spell.}
...
\spell{name = Switch Places, school = Charms, discipline = Kinesis, type = Instant, level =Expert, range =Close, incant = allaxo, noDur = 1, noHigh = 1, resist = Power, noBlock = 1, effect =Target two objects within range\comma{} and magical switch the two objects in space. 

If at least one of the objects is a sentient being\comma{} they may each attempt to Resist. If even one resist attempt is successful\comma{} the spell fails.}
}
...
\spell{name = Charm Creature, school = Illusion, discipline = Bewitchment, type = Instant, level =Novice, range =Close, incant = quorum, duration = 1 hour,noHigh = 1, resist = Logic, noBlock = 1, effect =Upon casting the spell\comma{} a pleasant aroma seems to suffuse around you\comma{} and you emit a calming aura. 
...
\spell{name = Implant Message, school = Illusion, discipline = Bewitchment, type = Ward, level =Novice, range =Wandtip, incant = occultus nuntius, duration = 100 years,higher = The ward can contain an additional 20 words \forEvery{}.,noResist =1, noBlock = 1, effect =Imbue a warded region with a message up to 20 words long. You can decide how this message is revealed (spoken verbally\comma{} or revealed through magical lettering) and the triggering condition for the message to be activated. 

The triggering condition can be whatever you choose\comma{} though it must be an audible or visual trigger and the detection range is 5 metres around the ward.}
\spell{name = Silent Illusion, school = Illusion, discipline = Bewitchment, type = Focus, level =Novice, range =Close, incant = lux, noDur = 1, noHigh = 1, resist = Observation, noBlock = 1, effect =Create an illusion\comma{} a construction of light. This illusion is silent and non\minus{}corporeal\comma{} but does not disintegrate on contact. Illusion may be manipulated and moved by the caster whilst Focus is maintained to mimic the illusion walking\comma{} for example\comma{} however the illusion disintegrates into nothing when focus is broken. An observer may determine that the illusion is not real by performing a Resist check as a major action\comma{} or by attempting to physically interact with it.}
}
 \spellBook{A Gentle Guide to Persuading the Mind}{Adept-level Bewitchment}{
\spell{name = Bedazzle, school = Illusion, discipline = Bewitchment, type = Ward, level =Adept, range =Wandtip, incant = chameleo, duration = 1 day,noHigh = 1, resist = Observation, noBlock = 1, effect =This spell creates a ward on the target\comma{} which produces a beddazzling and befuddling field\comma{} which causes eyes to simply slide off from the warded region without the brain properly processing it\comma{} rendering the warded target almost perfectly invisible. 
...
\spell{name = Soul Ripple, school = Illusion, discipline = Bewitchment, type = Instant, level =Master, range =Wandtip, incant = cessabit, duration = 10 minutes,noHigh = 1, resist = Evil, noBlock = 1, effect =With the gentlest of touches\comma{} you prod the mind of the targeted being\comma{} causing a ripple throughout their soul. A corrupted soul may attempt to resist this effect\comma{} negating it. 

You may choose to make the target either Immune or Susceptible to psychic damage for the duration of the spell.}
\spell{name = True Illusion, school = Illusion, discipline = Bewitchment, type = Ritual (10 minutes), level =Master, range =Sight, incant = stultuvisus, duration = 1 hours,noHigh = 1, resist = Investigation, noBlock = 1, effect =Create a perfect illusion of an environment (up to 20m in radius) or people (up to 3)\comma{} which can be interacted with and touched by the target. This illusion replicates sounds\comma{} smells heat and all other imaginable stimuli.
...
\spell{name = Waking Dreams, school = Illusion, discipline = Psionics, type = Focus, level =Expert, range =Close, incant = oneiro, noDur = 1, noHigh = 1, resist = Conviction, noBlock = 1, effect =Create an illusion\comma{} not out of light\comma{} but in the mind of a given individual. 
...
\spell{name = Dilute Blood, school = Maledictions, discipline = Curse, type = Instant, level =Adept, range =Close, incant = aenemius, duration = 1 miunte,noHigh = 1, resist = Vitality, noBlock = 1, effect =On a failed Resist\comma{} the target\apos{}s blood becomes thin and diluted\comma{} making them bleed profusely from even a minor cut. 
...
\spell{name = Cursed Step, school = Maledictions, discipline = Curse, type = Instant, level =Master, range =Close, incant = gradus maledictus, duration = 1 day,noHigh = 1, resist = Acrobatics, negation = Blockable  and Dodgeable,effect =When this spell hits the target\comma{} their very presence in an area is enough to leave a cursed aura. 
...
\spell{name = Revoke Power, school = Maledictions, discipline = Curse, type = Instant, level =Ascendant, range =Close, incant = anakalo, duration = 1 minute,noHigh = 1, resist = Power, noBlock = 1, effect =On a failed Resist\comma{} the caster may revoke one ability of the target for the duration of the spell. 

This includes degrading an Immunity to a Resistance\comma{} or removing a Resistance entirely. You may also remove any ability listed in a being\apos{}s ability or actions block\comma{} or remove a sapient being\apos{}s ability to cast spells from one magical discipline.}
...
\spell{name = Magnetising Strike, school = Maledictions, discipline = Hex, type = Instant, level =Beginner, range =Close, incant = adtraho, duration = 30 seconds,higher = \additional{1d8}{force},resist = Acrobatics or Speed, noBlock = 1, effect =A pulse of energy streaks out towards the target faster than a normal `dodge\apos{} could avoid. 
...
\spell{name = Shield of Mortality, school = Recuperation, discipline = Healing, type = Ward, level =Expert, range =Wandtip, incant = morte discerde, duration = 1 day,noHigh = 1, noResist =1, noBlock = 1, effect =You bless a targeted individual with a warm\comma{} healing energy. 
...
\spell{name = Degrade, school = Transfiguration, discipline = Alteration, type = Instant, level =Beginner, range =Close, incant = prolabor, duration = 1 minute,higher = This spell effects an additional object or being \forEvery{}.
...
An object might gain layer of grime\comma{} whilst imperfections might develop across the surface. A previously well\minus{}oiled joint might begin to produce a horrendous squeaking noise. This spell cannot fix a break  an object and remove functionality\comma{} but generally makes an object less pleasant and high\minus{}quality than it was before. When used in this fashion\comma{} the spell has no duration\comma{} and the degredations are considered permanent. 
...
For the duration of the refinement\comma{} whenever an effected being performs one of their selected checks\comma{} they must roll an additional 1d4 and subtract that result to the result of the roll.}
...
\spell{name = Refine, school = Transfiguration, discipline = Alteration, type = Instant, level =Beginner, range =Close, incant = excolo, duration = 1 minute,higher = This spell effects an additional object or being \forEvery{}.
...
\spell{name = Horrific Armaments, school = Transfiguration, discipline = Alteration, type = Instant, level =Novice, range =Self, incant = armatum, duration = 1 minute,higher = The damage dealt by these effects increases by 1d8\comma{} 1d6 and 1d6 respectively \forEvery{}.,noResist =1, noBlock = 1, effect =You alter your own body\comma{} molding it into a lethal weapon\comma{} choosing from one of these effects:

\begin{spellitemize}
\item You grow long claws and fangs: your melee attacks now deal 1d8 slashing damage + modifier 
\item You grow a large articulated tail ending in a vicious point which you can use to perform a melee attack at targets up to 2m away\comma{} dealing 1d6 piercing damage. 
\item Your body sprouts large spines all over\comma{} which deal 1d6 piercing damage to any being which performs a melee attack on you. 
\end{spellitemize}}
...
\spell{name = Undo Transformation, school = Transfiguration, discipline = Alteration, type = Instant, level =Novice, range =Close, incant = reparifarge, noDur = 1, noHigh = 1, noResist =1, noBlock = 1, effect =Transfiguration countercharm: undoes the effect of any one spell from the {\it Alteration} spell. 
...
\spell{name = Irongrip, school = Transfiguration, discipline = Alteration, type = Instant, level =Adept, range =Wandtip, incant = fero, duration = 1 hour,noHigh = 1, noResist =1, noBlock = 1, effect =Gives a willing target an incredibly strong grip. Gain check advantage on all grappling checks and attempts to resist disarmament.}
...
\spell{name = Selfshift, school = Transfiguration, discipline = Alteration, type = Instant, level =Master, range =Self, incant = muto, noDur = 1, noHigh = 1, noResist =1, noBlock = 1, effect =You assume the form of any object or animal you wish\comma{} provided it has approximately the same size as you. Your equipment and clothing melds into your new form.

You take on the physical attributes and abilities of your new form\comma{} though you keep your intellect and consciousness intact: replace your \attPhys{}\comma{} \attFin{}\comma{} \attChr{} and \attPow{} attributes with those of your new form. 

You are indistinguishable from this chosen form until you choose to break the spell\comma{} or the being you appear to be is `destroyed'\comma{} at which point you revert to your normal form. Any damage taken in your new form is carried over to your true form. If this would reduce you to 0HP\comma{} you fall unconscious and take the {\it Critical Condition} status. 

You can only take actions that your assumed form may take\comma{} and may only speak or cast spells if your chosen form can do so – with the exception of ending this spell.}
}
...
\spell{name = True Transfiguration, school = Transfiguration, discipline = Alteration, type = Instant, level =Ascendant, range =Close, incant = omnio mutare, noDur = 1, noHigh = 1, resist = Power, noBlock = 1, effect =On a failed resist\comma{} the target undergoes a complete and true transformation of their nature\comma{} on both a spiritual and a physical level. 

To all intents and purposes\comma{} the target acts as if they have always been of your chosen form – replacing all of their statistics and abilities with those of the assumed form. 

This spell cannot\comma{} however\comma{} {\it create} a soul. Attempting to convert a non\minus{}living\comma{} dead\comma{} or un\minus{}life object or being into a sapient creature results in spell failure. 

This spell is permanent\comma{} and cannot be dispelled. The only way to undo the effects of this spell is through a second {\it True Transfiguration} back into the original form.}
}
...
\spell{name = Army of the Dead, school = Dark Arts, discipline = Necromancy, type = Ritual (1 day), level =Ascendant, range =Self, noIncant = 1, duration = A year and a day,noHigh = 1, noResist =1, noBlock = 1, effect =You may raise the bodies of up to 10d20 deceased individuals found within a radius of 1 km. 
...
\spell{name = Soul Snare, school = Dark Arts, discipline = Necromancy, type = Instant, level =Ascendant, range =Self, incant = nerco decipula, noDur = 1, noHigh = 1, noResist =1, noBlock = 1, effect =Capture the soul of an enemy killed in the past 30 seconds. 
