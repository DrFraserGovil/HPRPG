...
\summaryEntry{Galleons}{0}

\summaryEntry{Sickles}{11}

\summaryEntry{Knuts}{24}

 \summaryHeader{Books}

\summaryEntry{The Illusion of Thin Air}{1}
...
\summaryEntry{Moobox of Teleportation}{1}

\summaryEntry{Peruvian Instant Darkness Powder}{4}

\summaryEntry{School Satchel}{1}

 \summaryHeader{Weapons}

\summaryEntry{Helena\apos{}s Wand}{1}
}
%%CharEnd
