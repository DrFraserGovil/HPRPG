...
\summaryEntry{Sickles}{10}

\summaryEntry{Knuts}{8}

 \summaryHeader{Books}

\summaryEntry{Cures\comma{} Cantrips and Coughs}{1}

 \summaryHeader{Clothing}

\summaryEntry{Gloves of Muromets}{1}

\summaryEntry{Heavy Shield}{1}
...
\summaryEntry{Crystal Ball}{1}

\summaryEntry{Food Supplies}{1}

\summaryEntry{School Satchel}{1}

 \summaryHeader{Potions}

\summaryEntry{Wiggenweld Potion}{3}

 \summaryHeader{Tools}

\summaryEntry{Alchemy Gear}{1}

 \summaryHeader{Weapons}

\summaryEntry{Apple and Unicorn Tail Hair Wand}{1}

\summaryEntry{Blunted Silver Greatsword}{1}

\summaryEntry{Dagger}{1}

\summaryEntry{Stone Battleaxe}{1}
}
%%CharEnd
