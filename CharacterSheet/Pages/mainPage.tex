...
%%% HEROISM BOX
\draw[rounded corners,\ddg,fill=\llg] ({\spellLimit+\widthUnits},{\heroHeight+0.5*\heightUnits})rectangle ({\secondRight},{0});
\def\yH{\heroHeight+0.5*\heightUnits}
\node[anchor=north] at ({\x},{\yH}) {\HP {Movement Speeds}};
