...
\foreach \a/\b [count = \q from 0] in { {Acrobatics}/{FNS}, {Arcane}/{INT}, {Chicanery}/{FNS}, {Conviction}/{SPR}, {Deception}/{CHR}, {Empathy}/{PRC}, {Flora \& Fauna}/{INT}, {History}/{INT}, {Intimidation}/{POW}, {Investigation}/{PRC}, {Observation}/{PRC}, {Performance}/{CHR}, {Persuasion}/{CHR}, {Research}/{INT}, {Speed}/{FIT}, {Stealth}/{FNS}, {Strength}/{FIT}, {Vitality}/{FIT}, {Willpower}/{SPR}}
{
	\def\y{\topQ - \q*\gap}
