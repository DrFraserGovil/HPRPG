...
\foreach \c [count = \q from 0] in { {Fitness}, {Finesse}, {Spirit}, {Charisma}, {Intelligence},{Perception}, {Power}, {Evil} }
{
...
\foreach \a/\b [count = \q from 0] in { {Acrobatics}/{FNS}, {Arcane}/{INT}, {Chicanery}/{FNS}, {Conviction}/{SPR}, {Deception}/{CHR}, {Empathy}/{PRC}, {History}/{INT}, {Intimidation}/{POW}, {Investigation}/{PRC}, {Logic}/{INT}, {Nature}/{INT}, {Observation}/{PRC}, {Performance}/{CHR}, {Persuasion}/{CHR}, {Research}/{INT}, {Speed}/{FIT}, {Stealth}/{FNS}, {Strength}/{FIT}, {Un-nature}/{INT}, {Vitality}/{FIT}, {Willpower}/{SPR}}
{
	\def\y{\topQ - \q*\gap}
	\draw (\x,\y) rectangle ({\x+\delta},{\y+\delta});
	\node[anchor = south west] (A) at ({\x+\delta-0.05},{\y-0.22}) {\scriptsize \a~\textcolor{gray!60}{(\b{})} }; 
