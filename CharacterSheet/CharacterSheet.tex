...
\foreach \a/\b [count = \q from 0] in {  {Acrobatics}/{ATH},{Arcane}/{INT}, {Chaos}/{EVL}, {Compassion}/{PER},{Deception}/{CHR}, {Dexterity}/{FIN}, {Endurance}/{SPR},  {Intimidation}/{EVL}, {History}/{INT},{Nature}/{INT}, {Observation}/{PER\hspace{-0.7ex}} ,{Performance}/{CHR}, {Persuasion}/{CHR}, {Precision}/{FIN},{Research}/{INT}, {Speed}/{ATH},{Stealth}/{FIN},{Strength}/{ATH},  {Willpower}/{SPR}}
{
	\def\y{\topQ - \q*\gap}
